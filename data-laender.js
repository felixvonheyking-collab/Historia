...
"Italien":{"color":"#2f6b4f","events":[{"year":-753,"title":"Sagenhafte Gründung Roms","text":"Die Überlieferung nennt dieses Jahr; archäologisch ist eine dauerhafte Siedlung auf dem Palatin bereits im 10. Jahrhundert v. Chr. nachweisbar."},{"year":-509,"title":"Vertreibung der Könige","text":"Rom wird Republik. Die Verfassung mit Konsuln, Senat und Volksversammlungen prägt europäisches Staatsdenken bis in die Neuzeit."},{"year":-146,"title":"Zerstörung Karthagos","text":"Nach drei Punischen Kriegen ist Rom unbestrittene Macht des westlichen Mittelmeers."},{"year":476,"title":"Absetzung des letzten weströmischen Kaisers","text":"Odoaker setzt Romulus Augustulus ab. Zeitgenossen empfanden das kaum als Epochenbruch – die Verwaltung lief weiter."},{"year":1077,"title":"Canossa","text":"Heinrich IV. tut vor Papst Gregor VII. in der Burg der Markgräfin Mathilde Buße – ein Höhepunkt des Investiturstreits auf italienischem Boden."},{"year":1204,"title":"Venedig lenkt den Kreuzzug um","text":"Die Republik bringt das Kreuzfahrerheer dazu, Konstantinopel zu plündern, und sichert sich das Handelsmonopol im östlichen Mittelmeer."},{"year":1348,"title":"Der Schwarze Tod erreicht Italien","text":"Über genuesische Schiffe kommt die Pest nach Europa. Boccaccios Decamerone entsteht als literarische Antwort auf die Katastrophe."},{"year":1401,"title":"Wettbewerb um die Bronzetüren von Florenz","text":"Ghiberti setzt sich gegen Brunelleschi durch – der Streit gilt als symbolischer Auftakt der Renaissance."},{"year":1494,"title":"Beginn der Italienischen Kriege","text":"Karl VIII. von Frankreich marschiert ein. Über sechzig Jahre wird Italien Schlachtfeld fremder Mächte – der Hintergrund von Machiavellis Denken."},{"year":1633,"title":"Prozess gegen Galilei","text":"Der Inquisitionsprozess endet mit Widerruf und Hausarrest. Erst 1992 erklärte die Kirche das Urteil offiziell für einen Fehler."},{"year":1861,"title":"Königreich Italien ausgerufen","text":"Nach Garibaldis Zug der Tausend und Cavours Diplomatie entsteht ein Nationalstaat. Rom kommt erst 1870 hinzu."},{"year":1922,"title":"Marsch auf Rom","text":"Mussolini wird zum Regierungschef ernannt – die erste faschistische Machtübernahme Europas, Vorbild für spätere Bewegungen."},{"year":1943,"title":"Sturz Mussolinis und Kriegswende","text":"Italien wechselt die Seiten, das Land wird zum Kriegsschauplatz und zerfällt bis 1945 in zwei Teile."},{"year":1946,"title":"Referendum: Republik statt Monarchie","text":"Mit knapper Mehrheit endet das Haus Savoyen. Frauen stimmen erstmals landesweit mit ab."},{"year":1957,"title":"Römische Verträge","text":"In Rom wird die Europäische Wirtschaftsgemeinschaft gegründet – der Grundstein der heutigen EU."},{"year":1992,"title":"Ermittlungen „Saubere Hände\"","text":"Ein Korruptionsskandal legt das gesamte Parteiensystem der Nachkriegszeit lahm und lässt es binnen zwei Jahren zerfallen."}]},"Griechenland":{"color":"#2a5b8a","events":[{"year":-1600,"title":"Blüte der mykenischen Paläste","text":"Befestigte Zentren wie Mykene und Tiryns beherrschen die Ägäis. Ihre Schrift Linear B wurde erst 1952 entziffert."},{"year":-1200,"title":"Zusammenbruch der Palastkultur","text":"Innerhalb weniger Jahrzehnte verschwinden Schrift, Fernhandel und Paläste. Die Ursachen sind bis heute umstritten."},{"year":-776,"title":"Erste überlieferte Olympische Spiele","text":"Die Siegerlisten setzen ein – für die Griechen der Beginn gemeinsamer Zeitrechnung."},{"year":-508,"title":"Reformen des Kleisthenes","text":"Athen ordnet die Bürgerschaft nach Wohnbezirken statt nach Sippen. Damit beginnt die Demokratie im engeren Sinn."},{"year":-480,"title":"Salamis","text":"Die griechische Flotte schlägt die persische in der Meerenge bei Salamis – der Wendepunkt der Perserkriege."},{"year":-404,"title":"Niederlage Athens im Peloponnesischen Krieg","text":"Nach 27 Jahren Krieg gegen Sparta endet die athenische Vormacht. Thukydides schrieb die Geschichte dieses Krieges mit."},{"year":-338,"title":"Chaironeia","text":"Philipp II. von Makedonien besiegt Athen und Theben. Die Zeit der unabhängigen Stadtstaaten ist vorbei."},{"year":-146,"title":"Zerstörung Korinths","text":"Rom macht Griechenland zur Provinz. Kulturell aber erobert der Besiegte den Sieger – römische Bildung wird griechisch."},{"year":1453,"title":"Fall Konstantinopels","text":"Das byzantinische Reich, griechischsprachig und orthodox, endet. Gelehrte fliehen nach Italien und beleben dort die Antikenkenntnis."},{"year":1821,"title":"Beginn des Unabhängigkeitskriegs","text":"Der Aufstand gegen das Osmanische Reich begeistert halb Europa; Lord Byron stirbt 1824 in Missolonghi."},{"year":1832,"title":"Königreich Griechenland","text":"Die Großmächte setzen den bayerischen Prinzen Otto als König ein – ein von außen entworfener Staat."},{"year":1922,"title":"Kleinasiatische Katastrophe","text":"Die Niederlage gegen die Türkei beendet die griechische Präsenz in Anatolien; über eine Million Menschen werden umgesiedelt."},{"year":1941,"title":"Deutsche Besetzung","text":"Nach dem Scheitern des italienischen Angriffs greift die Wehrmacht ein. Die Besatzung fordert durch Hungersnot und Repressalien Hunderttausende Opfer."},{"year":1946,"title":"Bürgerkrieg","text":"Bis 1949 kämpfen Regierung und kommunistische Partisanen. Der Konflikt gilt als erster heißer Krieg des Kalten Krieges."},{"year":1967,"title":"Militärputsch der Obristen","text":"Sieben Jahre Diktatur, die 1974 nach dem Zypern-Abenteuer zusammenbricht."},{"year":1981,"title":"Beitritt zur Europäischen Gemeinschaft","text":"Griechenland wird zehntes Mitglied – ein bewusst politisches Signal zur Sicherung der jungen Demokratie."}]},"Skandinavien":{"color":"#1f6b7d","events":[{"year":793,"title":"Überfall auf Lindisfarne","text":"Der Angriff auf das Inselkloster gilt als Beginn der Wikingerzeit – vor allem, weil erstmals jemand darüber schrieb."},{"year":874,"title":"Besiedlung Islands","text":"Norweger lassen sich auf der bis dahin nahezu unbewohnten Insel nieder; die Sagas berichten davon Jahrhunderte später."},{"year":930,"title":"Das Althing auf Island","text":"Die jährliche Versammlung freier Bauern gilt als eines der ältesten fortbestehenden Parlamente der Welt."},{"year":1000,"title":"Leif Eriksson erreicht Vinland","text":"Rund fünfhundert Jahre vor Kolumbus landen Nordleute in Nordamerika. Die Siedlungsspuren in L'Anse aux Meadows bestätigen es."},{"year":1066,"title":"Stamford Bridge","text":"Der Tod Harald Hardradas in England markiert das Ende der großen Wikingerzüge – drei Wochen vor Hastings."},{"year":1397,"title":"Kalmarer Union","text":"Dänemark, Norwegen und Schweden unter einer Krone – eine Personalunion, die über hundert Jahre hält."},{"year":1520,"title":"Stockholmer Blutbad","text":"Die Hinrichtung schwedischer Adliger löst den Aufstand aus, der 1523 zur Unabhängigkeit unter Gustav Wasa führt."},{"year":1630,"title":"Schweden greift in den Dreißigjährigen Krieg ein","text":"Gustav II. Adolf landet in Pommern und wird zur Schutzmacht der Protestanten; er fällt 1632 bei Lützen."},{"year":1709,"title":"Poltawa","text":"Karl XII. unterliegt Peter dem Großen. Schwedens Zeit als Großmacht endet, Russlands beginnt."},{"year":1814,"title":"Norwegische Verfassung von Eidsvoll","text":"Norwegen gibt sich eine der freiheitlichsten Verfassungen Europas – und wird trotzdem an Schweden abgetreten."},{"year":1905,"title":"Norwegen wird unabhängig","text":"Die Union mit Schweden wird friedlich aufgelöst – bemerkenswert in einem Jahrhundert der Nationalkriege."},{"year":1917,"title":"Finnland erklärt seine Unabhängigkeit","text":"Nach der russischen Revolution löst sich das Großfürstentum; es folgt ein blutiger Bürgerkrieg."},{"year":1939,"title":"Winterkrieg","text":"Finnland leistet der sowjetischen Übermacht monatelang Widerstand und verliert Karelien, bleibt aber unbesetzt."},{"year":1940,"title":"Besetzung Dänemarks und Norwegens","text":"Schweden bleibt neutral – eine bis heute umstrittene Neutralität, die Erztransporte nach Deutschland einschloss."},{"year":1943,"title":"Rettung der dänischen Juden","text":"In wenigen Nächten werden über 7.000 Menschen nach Schweden gebracht – die erfolgreichste Rettungsaktion im besetzten Europa."},{"year":1969,"title":"Erdölfund in der Nordsee","text":"Das Ekofisk-Feld macht Norwegen binnen einer Generation zu einem der reichsten Länder der Welt."},{"year":2024,"title":"Schweden tritt der NATO bei","text":"Nach über zweihundert Jahren Bündnisfreiheit – eine Folge des russischen Angriffs auf die Ukraine. Finnland war 2023 vorausgegangen."}]},"Korea":{"color":"#5b7d1f","events":[{"year":-108,"title":"Han-China richtet Kommandanturen ein","text":"Nach dem Ende von Gojoseon kontrolliert China Teile der Halbinsel – der Beginn einer jahrhundertelangen Wechselbeziehung."},{"year":372,"title":"Buddhismus erreicht Goguryeo","text":"Über China kommt der Buddhismus, wird Staatsreligion und prägt Kunst, Schrift und Denken – auch Japans, das ihn von Korea empfängt."},{"year":676,"title":"Silla einigt die Halbinsel","text":"Mit chinesischer Hilfe und anschließend gegen sie setzt sich Silla durch – die erste Einigung Koreas."},{"year":918,"title":"Gründung von Goryeo","text":"Von diesem Reichsnamen leitet sich das westliche Wort Korea ab."},{"year":1234,"title":"Druck mit beweglichen Metalllettern","text":"Koreanische Drucker verwenden Metalltypen – rund zwei Jahrhunderte vor Gutenberg. Die Technik verbreitete sich jedoch nicht nach Westen."},{"year":1392,"title":"Beginn der Joseon-Dynastie","text":"Fünf Jahrhunderte konfuzianisch geprägter Herrschaft beginnen – eine der langlebigsten Dynastien der Weltgeschichte."},{"year":1446,"title":"Verkündung des Hangul","text":"König Sejong lässt eine eigene Schrift entwerfen, die jeder in wenigen Tagen erlernen kann. Die Gelehrtenelite wehrte sich dagegen."},{"year":1592,"title":"Japanische Invasion","text":"Admiral Yi Sun-sin schlägt die japanische Flotte mit seinen gepanzerten Schildkrötenschiffen und rettet das Land."},{"year":1866,"title":"Abschottungspolitik","text":"Korea weist westliche Kontaktversuche ab und erhält den Beinamen Einsiedlerkönigreich."},{"year":1910,"title":"Annexion durch Japan","text":"35 Jahre Kolonialherrschaft mit Unterdrückung der Sprache, Zwangsarbeit und dem System der sogenannten Trostfrauen – bis heute eine Belastung der Beziehungen."},{"year":1919,"title":"Bewegung des 1. März","text":"Landesweite gewaltlose Unabhängigkeitsdemonstrationen werden blutig niedergeschlagen; sie prägen das nationale Selbstverständnis."},{"year":1945,"title":"Teilung am 38. Breitengrad","text":"Zwei amerikanische Offiziere ziehen in einer Nacht eine Linie auf der Landkarte. Sie besteht bis heute."},{"year":1950,"title":"Koreakrieg","text":"Drei Jahre Krieg mit Millionen Toten enden 1953 mit einem Waffenstillstand – ein Friedensvertrag wurde nie geschlossen."},{"year":1980,"title":"Aufstand von Gwangju","text":"Die Niederschlagung durch das Militär kostet Hunderte das Leben und wird zum Wendepunkt der südkoreanischen Demokratiebewegung."},{"year":1987,"title":"Demokratisierung Südkoreas","text":"Massenproteste erzwingen freie Präsidentschaftswahlen und das Ende der Militärherrschaft."},{"year":1988,"title":"Olympische Spiele in Seoul","text":"Der internationale Auftritt eines Landes, das eine Generation zuvor zu den ärmsten der Welt gehörte."}]},"Westafrika":{"color":"#c9701c","events":[{"year":300,"title":"Aufstieg des Reiches Ghana","text":"Zwischen Senegal und Niger entsteht ein Reich, das den Handel mit Gold und Salz über die Sahara kontrolliert. Mit dem heutigen Staat Ghana ist es geografisch nicht identisch."},{"year":800,"title":"Blüte von Djenné-Djenno","text":"Eine der ältesten Städte Afrikas südlich der Sahara – gewachsen ohne königlichen Palast und ohne Stadtmauer, was gängige Staatsmodelle in Frage stellt."},{"year":1235,"title":"Gründung des Mali-Reiches","text":"Sundiata Keïta besiegt seine Gegner und begründet ein Großreich. Die Kouroukan Fouga, eine mündlich überlieferte Verfassung, regelt Rechte und Pflichten."},{"year":1324,"title":"Pilgerfahrt des Mansa Musa","text":"Der Herrscher Malis reist mit einem riesigen Gefolge nach Mekka und verschenkt in Kairo so viel Gold, dass dessen Wert dort jahrelang gedrückt bleibt."},{"year":1375,"title":"Mali auf der Katalanischen Weltkarte","text":"Europäische Kartografen zeichnen Mansa Musa mit Goldklumpen – Westafrika ist im europäischen Weltbild angekommen."},{"year":1468,"title":"Songhai erobert Timbuktu","text":"Unter Sonni Ali löst Songhai Mali als Vormacht ab. Timbuktu wird zum Zentrum von Handel und Gelehrsamkeit."},{"year":1500,"title":"Universität Sankoré","text":"In Timbuktu lehren und schreiben Gelehrte; die Handschriftensammlungen der Stadt umfassen bis heute Zehntausende Bände zu Recht, Astronomie und Medizin."},{"year":1591,"title":"Schlacht von Tondibi","text":"Eine marokkanische Armee mit Feuerwaffen zerschlägt das Songhai-Reich – ein früher Fall, in dem Schusswaffen ein Großreich entscheiden."},{"year":1600,"title":"Ausweitung des atlantischen Sklavenhandels","text":"Über drei Jahrhunderte werden schätzungsweise mehr als zwölf Millionen Menschen verschleppt; Westafrika ist die Hauptregion der Verschiffung."},{"year":1804,"title":"Sokoto-Kalifat","text":"Usman dan Fodios Reformbewegung begründet einen der größten afrikanischen Staaten des 19. Jahrhunderts."},{"year":1884,"title":"Berliner Konferenz","text":"Europäische Mächte teilen Afrika unter sich auf, ohne dass ein einziger Afrikaner am Tisch sitzt. Die gezogenen Grenzen bestehen weitgehend fort."},{"year":1897,"title":"Britische Strafexpedition gegen Benin","text":"Die Stadt wird zerstört und geplündert; die Benin-Bronzen gelangen in europäische Museen. Ihre Rückgabe wird seit den 2010er Jahren umgesetzt."},{"year":1957,"title":"Ghana wird unabhängig","text":"Als erste Kolonie südlich der Sahara – Kwame Nkrumah wird zur Leitfigur des Panafrikanismus."},{"year":1960,"title":"Das Afrikanische Jahr","text":"Siebzehn afrikanische Staaten erlangen die Unabhängigkeit, darunter Nigeria, Senegal, Mali und die Elfenbeinküste."},{"year":1967,"title":"Biafra-Krieg","text":"Der Sezessionskrieg in Nigeria fordert bis 1970 durch Kampfhandlungen und Hungerblockade über eine Million Opfer und prägt das Bild humanitärer Hilfe."},{"year":2012,"title":"Bedrohung der Handschriften von Timbuktu","text":"Bibliothekare bringen Zehntausende Manuskripte heimlich aus der Stadt, um sie vor Zerstörung zu bewahren."}]},"Äthiopien":{"color":"#3f7d3f","events":[{"year":100,"title":"Aufstieg des Reiches Aksum","text":"Ein Handelsreich am Roten Meer mit eigener Schrift und eigener Münzprägung – eine der wenigen Mächte der Antike, die eigenes Geld schlug."},{"year":330,"title":"Christianisierung","text":"König Ezana nimmt das Christentum an – Äthiopien gehört damit zu den ältesten christlichen Staaten der Welt."},{"year":615,"title":"Aufnahme der ersten Muslime","text":"Verfolgte Anhänger Mohammeds finden am aksumitischen Hof Zuflucht. Die Episode gilt als früher Fall religiöser Duldung."},{"year":1200,"title":"Felsenkirchen von Lalibela","text":"Elf Kirchen werden aus dem anstehenden Fels herausgemeißelt, von oben nach unten – ein Bauverfahren ohne Parallele."},{"year":1270,"title":"Salomonische Dynastie","text":"Die Herrscher leiten ihre Abstammung von Salomo und der Königin von Saba ab. Die Legende wird im Kebra Nagast festgehalten."},{"year":1541,"title":"Portugiesische Hilfstruppen","text":"Im Krieg gegen das Sultanat Adal erhält Äthiopien portugiesische Unterstützung – ein früher Fall europäischer Militärintervention in Afrika."},{"year":1636,"title":"Gondar wird Hauptstadt","text":"Erstmals seit Jahrhunderten hat der Hof einen festen Sitz; es entsteht eine Schloss- und Kirchenlandschaft."},{"year":1855,"title":"Reichseinigung unter Tewodros II.","text":"Nach der Zeit der Fürsten wird das zersplitterte Reich wieder zusammengeführt."},{"year":1896,"title":"Schlacht von Adwa","text":"Menelik II. schlägt die italienische Invasionsarmee vernichtend. Äthiopien bleibt als einziger afrikanischer Staat unkolonisiert – ein Symbol für die gesamte Bewegung gegen die Kolonialherrschaft."},{"year":1930,"title":"Krönung Haile Selassies","text":"Der Kaiser wird zur Symbolfigur weit über Afrika hinaus; in Jamaika entsteht in seinem Namen die Rastafari-Bewegung."},{"year":1935,"title":"Italienischer Überfall","text":"Mussolini lässt mit Giftgas angreifen. Der Völkerbund reagiert wirkungslos – ein Vorzeichen seines Scheiterns."},{"year":1941,"title":"Befreiung","text":"Nach fünf Jahren Besatzung kehrt Haile Selassie zurück; äthiopische Widerstandskämpfer und britische Truppen vertreiben die Italiener."},{"year":1963,"title":"Gründung der OAU in Addis Abeba","text":"Die Organisation für Afrikanische Einheit wird gegründet; die Stadt bleibt bis heute Sitz der Afrikanischen Union."},{"year":1974,"title":"Sturz des Kaisers","text":"Der Derg übernimmt die Macht; es folgen Terror, Zwangsumsiedlungen und die Hungersnot von 1984."},{"year":1991,"title":"Ende des Derg-Regimes","text":"Rebellenverbände nehmen Addis Abeba ein; Eritrea wird 1993 nach einem Referendum unabhängig."},{"year":2020,"title":"Krieg in Tigray","text":"Ein zweijähriger Konflikt mit hunderttausenden Toten; 2022 folgt ein Waffenstillstandsabkommen."}]},"Südostasien":{"color":"#1f7d6b","events":[{"year":802,"title":"Gründung des Khmer-Reiches","text":"Jayavarman II. lässt sich zum Weltenherrscher weihen – Beginn eines Reiches, das ein halbes Jahrtausend das Festland beherrscht."},{"year":825,"title":"Borobudur auf Java","text":"Die größte buddhistische Tempelanlage der Welt entsteht; sie wurde später aufgegeben und erst im 19. Jahrhundert wieder freigelegt."},{"year":1113,"title":"Bau von Angkor Wat","text":"Zunächst ein Vishnu-Tempel, später buddhistisch genutzt – die größte religiöse Anlage der Welt, umgeben von einem Bewässerungssystem für womöglich Hunderttausende Menschen."},{"year":1292,"title":"Marco Polo besucht Sumatra","text":"Er berichtet von islamisch geprägten Hafenstädten – der Islam breitet sich über den Handel aus, nicht durch Eroberung."},{"year":1400,"title":"Aufstieg von Malakka","text":"Der Hafen wird zur Drehscheibe zwischen Indischem Ozean und Südchinesischem Meer und zum Ausgangspunkt der Islamisierung der Inselwelt."},{"year":1511,"title":"Portugal erobert Malakka","text":"Der erste europäische Stützpunkt in der Region – der Beginn eines Jahrhunderte währenden Kampfes um die Gewürzrouten."},{"year":1602,"title":"Gründung der Niederländischen Ostindien-Kompanie","text":"Die erste Aktiengesellschaft der Welt mit eigenem Militär und dem Recht, Krieg zu führen und Verträge zu schließen."},{"year":1782,"title":"Beginn der Chakri-Dynastie in Siam","text":"Bangkok wird Hauptstadt. Siam bleibt als einziges Land der Region formal unabhängig – durch geschickte Diplomatie zwischen Briten und Franzosen."},{"year":1815,"title":"Ausbruch des Tambora","text":"Der stärkste Vulkanausbruch der Neuzeit auf Sumbawa führt weltweit zum Jahr ohne Sommer, mit Missernten bis nach Europa und Nordamerika."},{"year":1887,"title":"Französisch-Indochina","text":"Vietnam, Kambodscha und später Laos werden zu einer Kolonialverwaltung zusammengefasst."},{"year":1942,"title":"Japanische Besetzung","text":"Binnen Monaten fallen die europäischen Kolonien. Der Mythos europäischer Unbesiegbarkeit zerbricht und beschleunigt die Unabhängigkeitsbewegungen."},{"year":1945,"title":"Indonesien erklärt seine Unabhängigkeit","text":"Sukarno ruft die Republik aus; erst nach vier Jahren Krieg erkennen die Niederlande sie an."},{"year":1954,"title":"Dien Bien Phu","text":"Die Niederlage beendet die französische Kolonialherrschaft in Indochina und teilt Vietnam."},{"year":1965,"title":"Massaker in Indonesien","text":"Nach einem gescheiterten Putsch werden Hunderttausende als angebliche Kommunisten getötet; die Aufarbeitung steht bis heute aus."},{"year":1975,"title":"Machtübernahme der Roten Khmer","text":"Bis 1979 sterben in Kambodscha schätzungsweise 1,5 bis 2 Millionen Menschen – ein Viertel der Bevölkerung."},{"year":1997,"title":"Asienkrise","text":"Der Zusammenbruch des thailändischen Baht löst eine regionale Finanzkrise aus und stürzt in Indonesien das Suharto-Regime."}]},"Brasilien & Südamerika":{"color":"#7d5b1f","events":[{"year":-1200,"title":"Chavín de Huántar","text":"In den peruanischen Anden entsteht ein Kultzentrum, das über Jahrhunderte eine gemeinsame Bildsprache in weiten Teilen der Region prägt."},{"year":100,"title":"Nazca-Linien","text":"Riesige Scharrbilder in der Wüste Südperus, die vom Boden aus kaum erkennbar sind. Ihre Funktion – Wasserkult, Prozessionswege, Astronomie – bleibt umstritten."},{"year":1438,"title":"Beginn der Inka-Expansion","text":"Unter Pachacútec wächst ein Reich mit über 30.000 Kilometern Straßen, Terrassenfeldern und Knotenschnüren als Verwaltungsmedium – ohne Rad, Geld und Alphabetschrift."},{"year":1500,"title":"Landung von Cabral in Brasilien","text":"Die Portugiesen erreichen die Küste. Der Vertrag von Tordesillas hatte das Gebiet bereits 1494 zugesprochen."},{"year":1532,"title":"Cajamarca","text":"Pizarro nimmt Atahualpa mit weniger als zweihundert Mann gefangen. Entscheidend waren Bürgerkrieg im Reich, Verbündete und vor allem eingeschleppte Seuchen."},{"year":1630,"title":"Quilombo dos Palmares","text":"Entflohene Versklavte gründen im Nordosten Brasiliens ein Gemeinwesen, das fast ein Jahrhundert besteht, bevor es 1694 zerschlagen wird."},{"year":1780,"title":"Aufstand des Túpac Amaru II.","text":"Die größte indigene Erhebung gegen die spanische Herrschaft wird niedergeschlagen; sein Name wird zum Symbol späterer Bewegungen."},{"year":1808,"title":"Der portugiesische Hof flieht nach Rio","text":"Vor Napoleon setzt der Königshof über den Atlantik – der einzige Fall, in dem eine europäische Monarchie ihre Kolonie zum Regierungssitz macht."},{"year":1819,"title":"Boyacá","text":"Simón Bolívars Sieg nach dem Marsch über die Anden entscheidet die Unabhängigkeit Kolumbiens und leitet die Befreiung des Nordens ein."},{"year":1822,"title":"Unabhängigkeit Brasiliens","text":"Dom Pedro erklärt die Loslösung – ohne Krieg, als Kaiserreich, was Brasilien einen anderen Weg als seine Nachbarn nimmt."},{"year":1864,"title":"Tripel-Allianz-Krieg","text":"Paraguay verliert im Krieg gegen Brasilien, Argentinien und Uruguay einen großen Teil seiner männlichen Bevölkerung – der verlustreichste Krieg Südamerikas."},{"year":1888,"title":"Abschaffung der Sklaverei in Brasilien","text":"Als letztes Land der westlichen Welt. Ein Jahr später fällt die Monarchie – die Grundbesitzer entzogen ihr die Unterstützung."},{"year":1930,"title":"Vargas kommt an die Macht","text":"Fünfzehn Jahre autoritäre Modernisierung prägen Brasiliens Wirtschaft, Arbeitsrecht und Selbstbild."},{"year":1960,"title":"Brasília wird Hauptstadt","text":"Eine am Reißbrett entworfene Stadt im Landesinneren, gebaut in gut drei Jahren – Symbol des Fortschrittsglaubens der Moderne."},{"year":1973,"title":"Putsch in Chile","text":"Der Sturz Allendes leitet siebzehn Jahre Diktatur ein und macht Chile zum Versuchsfeld radikaler Wirtschaftsreformen."},{"year":1985,"title":"Rückkehr zur Demokratie in Brasilien","text":"Nach 21 Jahren endet die Militärherrschaft; 1988 folgt eine neue Verfassung, die Land- und indigene Rechte festschreibt."}]},"Australien & Ozeanien":{"color":"#8a5b7d","events":[{"year":-50000,"title":"Besiedlung Australiens","text":"Menschen erreichen den Kontinent über Wasserwege – eine der frühesten bekannten Seefahrten der Menschheit. Die Aboriginal-Kulturen zählen damit zu den ältesten fortbestehenden der Welt."},{"year":-3000,"title":"Aufbruch der Lapita-Kultur","text":"Von Melanesien aus besiedeln Seefahrer über Jahrtausende den Pazifik – navigiert wird nach Sternen, Dünung und Vogelflug."},{"year":1000,"title":"Besiedlung Aotearoas","text":"Polynesische Seefahrer erreichen Neuseeland, die letzte große bewohnbare Landmasse der Erde. Aus ihnen werden die Maori."},{"year":1250,"title":"Errichtung der Moai","text":"Auf der Osterinsel entstehen die Steinfiguren. Die These vom selbstverschuldeten ökologischen Kollaps gilt heute als überzogen – Sklavenraub und eingeschleppte Krankheiten wogen schwerer."},{"year":1606,"title":"Erste dokumentierte europäische Landung","text":"Willem Janszoon erreicht die Kap-York-Halbinsel. Die Niederländer nennen den Kontinent Neuholland und finden ihn wirtschaftlich uninteressant."},{"year":1770,"title":"James Cook an der Ostküste","text":"Cook erklärt das Land für die britische Krone – unter der Rechtsfiktion terra nullius, niemandes Land, obwohl es besiedelt war."},{"year":1788,"title":"Die First Fleet in Botany Bay","text":"Britannien richtet eine Sträflingskolonie ein. Für die indigene Bevölkerung beginnt eine Katastrophe aus Krankheiten, Vertreibung und Gewalt."},{"year":1840,"title":"Vertrag von Waitangi","text":"Britische Krone und Maori-Häuptlinge schließen einen Vertrag – dessen englische und Maori-Fassung Entscheidendes unterschiedlich sagen. Der Streit darüber prägt Neuseeland bis heute."},{"year":1851,"title":"Goldrausch in Victoria","text":"Die Bevölkerung Australiens verdreifacht sich binnen eines Jahrzehnts; Einwanderer aus China stoßen auf offene Diskriminierung."},{"year":1901,"title":"Australischer Bund","text":"Die Kolonien schließen sich zusammen. Eines der ersten Gesetze begründet die White Australia Policy, die bis in die 1970er Jahre gilt."},{"year":1915,"title":"Gallipoli","text":"Australische und neuseeländische Truppen erleiden schwere Verluste. Der ANZAC Day ist bis heute der wichtigste Gedenktag beider Länder."},{"year":1942,"title":"Bombardierung von Darwin","text":"Japanische Angriffe auf australischen Boden lösen die außenpolitische Neuausrichtung von Großbritannien zu den USA aus."},{"year":1946,"title":"Atomtests im Pazifik","text":"Über Jahrzehnte testen USA, Großbritannien und Frankreich Kernwaffen; Bewohner von Bikini, Maralinga und Mururoa tragen die Folgen."},{"year":1967,"title":"Referendum über Aboriginal-Rechte","text":"Über 90 Prozent stimmen dafür, indigene Australier in die Volkszählung aufzunehmen und Bundesgesetze auf sie anzuwenden."},{"year":1992,"title":"Mabo-Urteil","text":"Der High Court verwirft die Fiktion terra nullius und erkennt indigene Landrechte an – die folgenreichste Gerichtsentscheidung der australischen Geschichte."},{"year":2008,"title":"Entschuldigung an die Gestohlenen Generationen","text":"Premierminister Rudd entschuldigt sich für die jahrzehntelange Wegnahme indigener Kinder von ihren Familien."}]},
  ...
  "Kanada": {
    color: "#b02a2a",
    events: [
      { year: 1000, title: "Nordleute in L'Anse aux Meadows", text: "Auf Neufundland entsteht die einzige gesicherte Wikingersiedlung Amerikas. Sie hielt nur wenige Jahre – ein Kontakt ohne Folgen, fünfhundert Jahre vor Kolumbus." },
      { year: 1497, title: "John Cabot erreicht die Ostküste", text: "Im englischen Auftrag landet er irgendwo zwischen Neufundland und Kap Breton; wo genau, ist bis heute strittig. Entscheidend war weniger das Land als der Fischreichtum davor." },
      { year: 1534, title: "Cartier nimmt Gaspé für Frankreich in Besitz", text: "Er errichtet ein Kreuz und verschleppt zwei Söhne des Irokesen-Häuptlings Donnacona nach Frankreich. Das Muster aus Inbesitznahme und Übergriff steht am Anfang." },
      { year: 1608, title: "Champlain gründet Québec", text: "Der Pelzhandel braucht feste Stützpunkte und indigene Partner. Neufrankreich entsteht als Handelsnetz, nicht als Siedlungskolonie – ein Grund, warum es dünn besiedelt blieb." },
      { year: 1670, title: "Charta der Hudson's Bay Company", text: "Ein Handelsunternehmen erhält Hoheitsrechte über ein Gebiet, das ein Drittel des heutigen Kanada umfasst – ohne dass jemals ein Europäer den größten Teil davon gesehen hätte." },
      { year: 1701, title: "Der Große Friede von Montreal", text: "1.300 Vertreter von rund vierzig indigenen Nationen verhandeln einen Monat lang mit Frankreich und beenden die Biberkriege. Ein Beleg dafür, dass indigene Mächte Vertragspartner auf Augenhöhe waren, nicht bloß Betroffene." },
      { year: 1759, title: "Schlacht auf der Abraham-Ebene", text: "Québec fällt an Britannien; beide Befehlshaber sterben. Der Krieg um Nordamerika war Teil eines Weltkriegs, der von Indien bis Schlesien geführt wurde." },
      { year: 1763, title: "Königliche Proklamation", text: "Nach dem Frieden von Paris erkennt die britische Krone indigenes Landrecht westlich der Appalachen an. Das Dokument ist bis heute Grundlage kanadischer Verfahren über Landansprüche." },
      { year: 1774, title: "Quebec Act", text: "Britannien garantiert französisches Zivilrecht und die katholische Religion. Das sichert die Loyalität Québecs – und treibt die englischen Kolonien im Süden weiter in Richtung Revolution." },
      { year: 1783, title: "Ankunft der Loyalisten", text: "Zehntausende verlassen die neuen Vereinigten Staaten, darunter mehrere tausend Schwarze Loyalisten, denen Freiheit versprochen worden war. Aus dieser Migration entsteht das englischsprachige Kanada." },
      { year: 1812, title: "Krieg gegen die Vereinigten Staaten", text: "Amerikanische Invasionsversuche scheitern, auch am Widerstand indigener Verbündeter unter Tecumseh. In Kanada gilt der Krieg als Gründungserzählung, in den USA ist er weitgehend vergessen." },
      { year: 1867, title: "Die Konföderation", text: "Der British North America Act vereinigt vier Provinzen zu einem Dominion. Anders als bei den Nachbarn im Süden geschieht die Staatsgründung ohne Krieg und ohne Bruch mit London." },
      { year: 1876, title: "Indian Act", text: "Ein Gesetz regelt fast jeden Lebensbereich indigener Menschen, von der Landnutzung bis zur Frage, wer überhaupt als indigen gilt. Es ist in geänderter Form bis heute in Kraft." },
      { year: 1885, title: "Nordwest-Aufstand und Fertigstellung der Eisenbahn", text: "Der Métis-Führer Louis Riel wird hingerichtet, im selben Jahr wird die Pazifikbahn vollendet. Gebaut haben sie zu einem großen Teil chinesische Arbeiter – die anschließend mit einer Kopfsteuer belegt wurden." },
      { year: 1917, title: "Vimy Ridge", text: "Vier kanadische Divisionen kämpfen erstmals gemeinsam und nehmen den Höhenzug. Der Sieg wird zum nationalen Symbol – erkauft mit 10.602 Verlusten in vier Tagen, darunter 3.598 Tote." },
      { year: 1931, title: "Statut von Westminster", text: "Kanada wird außenpolitisch souverän. Die Verfassung blieb allerdings bis 1982 ein britisches Gesetz, das nur London ändern konnte." },
      { year: 1982, title: "Verfassung und Charta der Rechte", text: "Kanada holt seine Verfassung heim und gibt sich einen Grundrechtekatalog. Québec hat dem Text bis heute nicht zugestimmt." },
      { year: 1995, title: "Referendum in Québec", text: "Die Unabhängigkeit wird mit 50,58 zu 49,42 Prozent abgelehnt – rund 54.000 Stimmen Unterschied bei einer Beteiligung von über 93 Prozent." },
      { year: 1999, title: "Gründung von Nunavut", text: "Aus den Nordwest-Territorien wird ein eigenes Territorium mit Inuit-Mehrheit ausgegliedert – die erste größere Grenzänderung Kanadas seit 1949." },
      { year: 2015, title: "Bericht der Wahrheits- und Versöhnungskommission", text: "Die Kommission bezeichnet das System der Residential Schools, in dem über ein Jahrhundert lang indigene Kinder ihren Familien entzogen wurden, als kulturellen Völkermord." }
    ]
  },
  "Karibik": {
    color: "#1f8a7d",
    events: [
      { year: -500, title: "Besiedlung von Südamerika aus", text: "Über Jahrhunderte ziehen Gruppen vom Orinoco die Inselkette hinauf. Aus ihnen gehen die Kulturen hervor, die Kolumbus vorfindet – keine unberührte Inselwelt, sondern ein dicht vernetzter Raum." },
      { year: 1492, title: "Kolumbus landet auf den Bahamas", text: "Er hält die Inseln für vorgelagertes Asien und nennt ihre Bewohner deshalb Indios. Der Irrtum steckt bis heute in der Bezeichnung Westindien." },
      { year: 1494, title: "Zuckerrohr kommt in die Karibik", text: "Auf der zweiten Reise eingeführt, wird es zur Pflanze, die die Geschichte der Region bestimmt: Zucker verlangt viele Arbeitskräfte auf engem Raum – und liefert die Begründung für die Sklaverei." },
      { year: 1518, title: "Erste direkte Sklaventransporte aus Afrika", text: "Die indigene Bevölkerung ist durch Zwangsarbeit und eingeschleppte Krankheiten weitgehend zusammengebrochen. Die Lücke wird über den Atlantik gefüllt." },
      { year: 1655, title: "England nimmt Jamaika", text: "Ein eigentlich gescheitertes Unternehmen gegen Hispaniola endet mit der Eroberung Jamaikas. Die Insel wird zum Zentrum britischer Zuckerproduktion und der Freibeuterei von Port Royal." },
      { year: 1697, title: "Frankreich erhält Saint-Domingue", text: "Der westliche Teil Hispaniolas wird französisch und binnen achtzig Jahren zur reichsten Kolonie der Welt – und zu der mit der höchsten Sterblichkeit unter den Versklavten." },
      { year: 1739, title: "Vertrag mit den Maroons von Jamaika", text: "Nach jahrzehntelangem Krieg schließt Britannien Frieden mit entflohenen Versklavten und erkennt ihr Land an. Der Preis: Sie mussten künftige Flüchtlinge ausliefern." },
      { year: 1791, title: "Aufstand in Saint-Domingue", text: "Der größte Sklavenaufstand der Geschichte beginnt. Unter Toussaint Louverture wird daraus ein Krieg gegen Frankreich, Spanien und England zugleich." },
      { year: 1804, title: "Haiti wird unabhängig", text: "Der einzige Staat, der aus einem erfolgreichen Sklavenaufstand hervorging. Die Sklavenhaltermächte reagierten mit diplomatischer Isolierung – die USA erkannten Haiti erst 1862 an." },
      { year: 1825, title: "Frankreich erzwingt eine Entschädigung", text: "Unter Androhung von Krieg verpflichtet sich Haiti zu 150 Millionen Francs für die enteigneten Sklavenhalter; 1838 auf 90 Millionen gesenkt. Mit Zinsen zahlte das Land bis 1947." },
      { year: 1834, title: "Abschaffung der Sklaverei im Britischen Reich", text: "Sie gilt zunächst nur eingeschränkt: Bis 1838 mussten die Befreiten unbezahlt weiterarbeiten. Entschädigt wurden nicht sie, sondern ihre früheren Eigentümer." },
      { year: 1845, title: "Kontraktarbeiter aus Indien", text: "Nach dem Ende der Sklaverei werden Hunderttausende aus Indien angeworben, vor allem nach Trinidad und Guyana. Ihre Nachkommen prägen die Bevölkerung dieser Länder bis heute." },
      { year: 1886, title: "Kuba schafft die Sklaverei ab", text: "Als vorletztes Land Amerikas, zwei Jahre vor Brasilien. Der Zuckerboom hatte das System hier am längsten profitabel gehalten." },
      { year: 1898, title: "Der Spanisch-Amerikanische Krieg", text: "Spanien verliert seine letzten Kolonien. Kuba wird formal unabhängig, Puerto Rico wird amerikanisch – und ist es bis heute, ohne volle Rechte im Bund." },
      { year: 1915, title: "Beginn der US-Besatzung Haitis", text: "Neunzehn Jahre lang kontrollieren die USA Verwaltung und Finanzen. Sie hinterlassen Straßen, eine Armee und eine Zentralisierung, die spätere Diktaturen erleichterte." },
      { year: 1959, title: "Die Kubanische Revolution", text: "Castro stürzt Batista. Die Insel wird für dreißig Jahre Verbündeter Moskaus und Schauplatz der gefährlichsten Konfrontation des Kalten Krieges." },
      { year: 1962, title: "Jamaika und Trinidad werden unabhängig", text: "Der Versuch einer gemeinsamen Westindischen Föderation war kurz zuvor gescheitert. Die Kleinstaatlichkeit der Region ist damit besiegelt." },
      { year: 1983, title: "US-Invasion in Grenada", text: "Nach einem Putsch marschieren amerikanische Truppen ein. Die Vereinten Nationen verurteilen den Einsatz – folgenlos." },
      { year: 2010, title: "Erdbeben in Haiti", text: "Über 200.000 Tote; die Zahl bleibt umstritten, weil eine belastbare Erfassung fehlte. Die milliardenschwere Hilfe gilt als Lehrstück darüber, wie Nothilfe an Strukturen scheitern kann." }
    ]
  },
  "Südliches Afrika": {
    color: "#8a7d1f",
    events: [
      { year: -2000, title: "Jäger, Sammler und die ersten Hirten", text: "Die San und später die Khoikhoi prägen die Region über Jahrtausende. Ihre Felsmalereien gehören zu den ältesten fortlaufenden Bildtraditionen der Welt." },
      { year: 1220, title: "Das Königreich Mapungubwe", text: "Am Limpopo entsteht der erste bekannte Staat des südlichen Afrika, mit räumlich abgesetzter Elite und Handel bis Indien und China. Das goldene Nashorn aus seinen Gräbern ist heute ein Nationalsymbol." },
      { year: 1300, title: "Groß-Simbabwe", text: "Die fugenlos gesetzten Steinmauern entstehen ohne Mörtel. Koloniale Autoren schrieben den Bau jahrzehntelang Fremden zu – die Archäologie hat das längst widerlegt." },
      { year: 1652, title: "Die Niederländer am Kap", text: "Jan van Riebeeck errichtet eine Versorgungsstation für Schiffe nach Asien. Aus dem Zwischenstopp wird binnen einer Generation eine Siedlungskolonie mit versklavter Arbeit." },
      { year: 1795, title: "Britannien besetzt das Kap", text: "Zunächst vorübergehend, ab 1806 dauerhaft. Der Wechsel der Kolonialmacht legt den Grundkonflikt zwischen Briten und Buren an." },
      { year: 1818, title: "Aufstieg Shakas und das Mfecane", text: "Das Zulu-Reich entsteht, begleitet von großflächigen Umwälzungen im Binnenland. Wie viel davon auf Shaka zurückgeht und wie viel auf Dürre, Sklavenraub und Landhunger der Siedler, ist bis heute umstritten." },
      { year: 1836, title: "Der Große Treck", text: "Buren ziehen ins Landesinnere, auch aus Protest gegen die britische Abschaffung der Sklaverei. Aus dem Zug entstehen die Burenrepubliken – und ein Gründungsmythos." },
      { year: 1867, title: "Diamanten bei Kimberley", text: "Der Fund verwandelt eine Agrarkolonie in einen Industriestandort und zieht Arbeitsmigranten aus dem ganzen südlichen Afrika an. Das Wanderarbeitersystem beginnt hier." },
      { year: 1879, title: "Isandlwana und Ulundi", text: "Die Zulu vernichten eine britische Kolonne, verlieren aber den Krieg innerhalb eines halben Jahres. Der Schock beschleunigte die britische Eroberung, statt sie aufzuhalten." },
      { year: 1886, title: "Gold am Witwatersrand", text: "Das größte Goldvorkommen der Welt macht die Burenrepublik Transvaal reich – und für Britannien zum Ziel. Johannesburg entsteht aus dem Nichts." },
      { year: 1899, title: "Zweiter Burenkrieg", text: "Britannien setzt gegen den Guerillakrieg der Buren verbrannte Erde und Lager ein, in denen Zehntausende Frauen, Kinder und schwarze Landarbeiter sterben. Das Wort Konzentrationslager wird hier geprägt." },
      { year: 1910, title: "Die Südafrikanische Union", text: "Briten und Buren einigen sich – auf Kosten der schwarzen Mehrheit, die vom Wahlrecht praktisch ausgeschlossen bleibt. Die Versöhnung der Weißen ist die Grundlage des späteren Apartheidstaats." },
      { year: 1912, title: "Gründung des späteren ANC", text: "Der South African Native National Congress entsteht als Reaktion auf den Ausschluss aus der Union. Er wird die älteste Befreiungsbewegung des Kontinents." },
      { year: 1913, title: "Natives Land Act", text: "Etwa sieben Prozent der Landesfläche werden der schwarzen Bevölkerungsmehrheit zugewiesen, Landkauf außerhalb verboten. 1936 wird der Anteil auf gut dreizehn Prozent erhöht. Die Folgen dieser Verteilung wirken bis heute." },
      { year: 1948, title: "Apartheid wird Regierungsprogramm", text: "Die Nationale Partei gewinnt die Wahl und gießt bestehende Trennung in ein lückenloses Gesetzeswerk. Neu war nicht die Diskriminierung, sondern ihre Systematik." },
      { year: 1960, title: "Sharpeville", text: "Polizisten erschießen 69 Demonstranten gegen die Passgesetze, viele von hinten. Danach werden ANC und PAC verboten – und wenden sich dem bewaffneten Kampf zu." },
      { year: 1964, title: "Rivonia-Prozess", text: "Mandela und Mitangeklagte werden zu lebenslanger Haft verurteilt. Seine Verteidigungsrede über eine Gesellschaft, für die er zu sterben bereit sei, wird weltweit gelesen." },
      { year: 1976, title: "Aufstand in Soweto", text: "Schüler protestieren gegen Afrikaans als Unterrichtssprache; die Polizei schießt. Die Bilder beenden international die letzte Nachsicht mit dem Regime." },
      { year: 1990, title: "Freilassung Mandelas", text: "De Klerk hebt das Verbot des ANC auf. Vier Jahre Verhandlungen unter fortgesetzter Gewalt folgen, bevor der Übergang gelingt." },
      { year: 1994, title: "Erste allgemeine Wahlen", text: "Zum ersten Mal wählen alle Südafrikaner. Die anschließende Wahrheits- und Versöhnungskommission tauscht Aufklärung gegen Amnestie – ein weltweit kopiertes und bis heute umstrittenes Modell." }
    ]
  },
  "Ostafrika & Swahiliküste": {
    color: "#1f6b3f",
    events: [
      { year: 50, title: "Der Periplus des Erythräischen Meeres", text: "Ein griechischer Handelsführer beschreibt Häfen an der ostafrikanischen Küste und den Warenverkehr mit Arabien und Indien. Die Region ist von Anfang an Teil des Indischen Ozeans, nicht Hinterland." },
      { year: 800, title: "Die Swahili-Städte entstehen", text: "Aus dem Zusammentreffen von Bantu-Bevölkerung, Islam und Seehandel entwickelt sich eine eigene Stadtkultur mit eigener Sprache – Kiswahili ist eine Bantusprache mit arabischem Wortschatz, keine arabische Kolonialsprache." },
      { year: 1000, title: "Aufstieg Kilwas", text: "Die Stadt kontrolliert den Goldexport aus dem Hinterland Simbabwes und prägt eigene Münzen. Ihre Große Moschee ist einer der ältesten erhaltenen Sakralbauten südlich der Sahara." },
      { year: 1331, title: "Ibn Battuta besucht Kilwa", text: "Der marokkanische Reisende nennt sie eine der schönsten Städte der Welt. Sein Bericht ist eine der wenigen ausführlichen Außenbeschreibungen der Küste vor der europäischen Zeit." },
      { year: 1417, title: "Eine Giraffe für den Kaiser von China", text: "Gesandte aus Malindi bringen mit Zheng Hes Flotte eine Giraffe nach Peking, wo sie als Glückstier gedeutet wird. Ostafrika und China standen in direktem diplomatischem Kontakt." },
      { year: 1498, title: "Vasco da Gama an der Küste", text: "In Malindi findet er einen Lotsen, der ihn nach Indien bringt. Die Portugiesen treten in ein bestehendes Handelsnetz ein – sie erschließen es nicht, sie übernehmen es gewaltsam." },
      { year: 1505, title: "Portugal plündert Kilwa und Mombasa", text: "Innerhalb weniger Jahre bricht die alte Städtekultur zusammen. Der Handel verlagert sich, viele Orte erholen sich nie." },
      { year: 1698, title: "Oman vertreibt die Portugiesen", text: "Nach fast dreijähriger Belagerung fällt Fort Jesus in Mombasa. Die Vorherrschaft im westlichen Indischen Ozean wechselt zurück an eine regionale Macht." },
      { year: 1840, title: "Sansibar wird Residenz des Sultans von Oman", text: "Said bin Sultan verlegt seinen Sitz nach Afrika. Die Insel wird Zentrum des Gewürznelkenanbaus – und des ostafrikanischen Sklavenhandels." },
      { year: 1873, title: "Schließung des Sklavenmarkts von Sansibar", text: "Unter britischem Druck; der Handel verlagert sich zunächst in den Untergrund. Der ostafrikanische Sklavenhandel wird in Europa bis heute weit weniger erinnert als der atlantische." },
      { year: 1885, title: "Deutsch-Ostafrika entsteht", text: "Nach der Berliner Konferenz sichert sich das Deutsche Reich das Gebiet des heutigen Tansania, Ruanda und Burundi – erworben durch Verträge, deren Inhalt die Unterzeichner meist nicht kannten." },
      { year: 1896, title: "Der Anglo-Sansibar-Krieg", text: "Er dauert achtunddreißig Minuten und gilt als kürzester Krieg der Geschichte. Auf sansibarischer Seite gab es rund fünfhundert Tote und Verwundete, auf britischer einen Verletzten – das Missverhältnis ist die eigentliche Aussage." },
      { year: 1905, title: "Der Maji-Maji-Krieg", text: "Der Aufstand gegen die deutsche Kolonialherrschaft wird mit verbrannter Erde beantwortet. Die Schätzungen der Toten reichen von 75.000, wie die Kolonialverwaltung angab, bis zu 300.000; die meisten starben an der herbeigeführten Hungersnot." },
      { year: 1952, title: "Der Mau-Mau-Aufstand", text: "Britannien internierte in Kenia Zehntausende in Lagern; Folter war verbreitet. Erst 2013 zahlte London 19,9 Millionen Pfund an 5.228 Überlebende – verbunden mit dem Ausdruck von Bedauern, ausdrücklich nicht mit einer Entschuldigung." },
      { year: 1961, title: "Tanganjika wird unabhängig", text: "Nyerere führt das Land ohne Krieg in die Unabhängigkeit. Kenia folgt 1963, Uganda 1962." },
      { year: 1964, title: "Revolution und Union", text: "Nach dem Sturz des Sultans von Sansibar schließt sich die Insel mit Tanganjika zu Tansania zusammen. Die Union besteht bis heute, mit anhaltenden Spannungen." },
      { year: 1994, title: "Der Völkermord in Ruanda", text: "In gut hundert Tagen werden schätzungsweise 800.000 Menschen getötet, überwiegend Tutsi. Die internationale Gemeinschaft zog Truppen ab, statt einzugreifen – das Versagen ist bis heute Bezugspunkt jeder Debatte über Schutzverantwortung." },
      { year: 2007, title: "M-Pesa in Kenia", text: "Geldüberweisung per einfachem Mobiltelefon, ohne Bankkonto. Ostafrika übersprang eine Entwicklungsstufe, die Europa noch mit sich herumträgt – ein seltener Fall, in dem der Norden vom Süden lernt." }
    ]
  },
  "Ostmitteleuropa": {
    color: "#8a3f6b",
    events: [
      { year: 966, title: "Die Taufe Mieszkos I.", text: "Der Piastenherrscher nimmt das Christentum an – über Böhmen, nicht über das Ostfrankenreich. Die Entscheidung sichert Polen die Eigenständigkeit gegenüber dem westlichen Nachbarn." },
      { year: 1000, title: "Das Treffen von Gnesen", text: "Kaiser Otto III. besucht das Grab des Adalbert und erkennt Polen als gleichrangig an. Sein Entwurf eines Europas mehrerer gleichberechtigter Königreiche zerfiel nach seinem frühen Tod." },
      { year: 1241, title: "Der Mongolensturm", text: "Bei Liegnitz wird ein polnisch-deutsches Heer vernichtend geschlagen, Ungarn wird verwüstet. Der Rückzug der Mongolen nach dem Tod des Großkhans rettete die Region, nicht ihr Widerstand." },
      { year: 1348, title: "Gründung der Universität Prag", text: "Die erste Universität nördlich der Alpen und östlich von Paris. Karl IV. macht Prag zum Zentrum des Reiches – ein Vorsprung, den die Region später verliert." },
      { year: 1385, title: "Die Union von Krewo", text: "Polen und Litauen verbinden sich dynastisch. Es entsteht der flächengrößte Staat Europas – und der letzte heidnische Herrscher des Kontinents lässt sich taufen." },
      { year: 1410, title: "Schlacht bei Tannenberg", text: "Das polnisch-litauische Heer schlägt den Deutschen Orden. Der Ort bekam im 20. Jahrhundert eine zweite, ganz andere Bedeutung – die deutsche Erinnerung an 1914 überschrieb bewusst die Niederlage von 1410." },
      { year: 1505, title: "Nihil novi", text: "Der König darf nichts ohne Zustimmung des Adelsparlaments beschließen. Polen-Litauen wird zur Adelsrepublik mit gewähltem König – ungewöhnlich für Europa und langfristig lähmend." },
      { year: 1569, title: "Die Union von Lublin", text: "Aus der Personalunion wird ein gemeinsamer Staat mit gemeinsamem Parlament. Die Warschauer Konföderation garantiert 1573 Religionsfrieden – zur selben Zeit, als Westeuropa Konfessionskriege führt." },
      { year: 1652, title: "Das erste Liberum veto", text: "Ein einzelner Abgeordneter kann den Reichstag auflösen. Was als Schutz der Freiheit gedacht war, macht den Staat über ein Jahrhundert regierungsunfähig." },
      { year: 1683, title: "Entsatz Wiens", text: "Jan III. Sobieski führt das Entsatzheer. Der letzte große außenpolitische Erfolg der Adelsrepublik – die zugleich innerlich längst blockiert war." },
      { year: 1772, title: "Erste Teilung Polens", text: "Russland, Preußen und Österreich nehmen sich Gebiete, ohne Krieg und mit Zustimmung des eingeschüchterten Reichstags." },
      { year: 1791, title: "Die Verfassung vom 3. Mai", text: "Sie schafft das Liberum veto ab und gilt als erste moderne Verfassung Europas – wie eng man den Begriff modern fasst, ist Definitionssache. Vier Jahre später existiert Polen nicht mehr." },
      { year: 1795, title: "Dritte Teilung", text: "Polen verschwindet für 123 Jahre von der Landkarte. Die Nation überlebt in Sprache, Literatur und Kirche – ein Beispiel dafür, dass Staat und Nation zweierlei sind." },
      { year: 1867, title: "Der Ausgleich mit Ungarn", text: "Österreich-Ungarn entsteht. Ungarn erhält weitgehende Eigenständigkeit; die slawischen Völker der Monarchie gehen leer aus, was die Doppelmonarchie dauerhaft belastet." },
      { year: 1918, title: "Staatsgründungen nach dem Weltkrieg", text: "Polen, die Tschechoslowakei und Ungarn entstehen oder erstehen neu. Die Grenzen folgen kaum je klaren Sprachgrenzen – überall bleiben große Minderheiten zurück." },
      { year: 1939, title: "Überfall auf Polen", text: "Deutschland greift am 1. September an, die Sowjetunion am 17. – beides vereinbart im Hitler-Stalin-Pakt. Polen wird zum Hauptschauplatz der deutschen Vernichtungspolitik." },
      { year: 1943, title: "Aufstand im Warschauer Ghetto", text: "Wenige hundert schlecht bewaffnete Kämpfer halten fast einen Monat stand. Es ist der erste größere städtische Aufstand im besetzten Europa." },
      { year: 1944, title: "Der Warschauer Aufstand", text: "63 Tage Kampf; Schätzungen sprechen von 150.000 bis 200.000 Toten, überwiegend Zivilisten. Die Rote Armee blieb jenseits der Weichsel stehen – aus militärischen oder politischen Gründen, darüber wird bis heute gestritten." },
      { year: 1956, title: "Ungarischer Volksaufstand", text: "Die sowjetische Intervention kostet Tausende das Leben; 200.000 Menschen fliehen. Der Westen greift nicht ein – eine Lehre, die den Ostblock für Jahrzehnte prägt." },
      { year: 1968, title: "Der Prager Frühling", text: "Der Versuch eines Sozialismus mit menschlichem Antlitz endet mit dem Einmarsch der Warschauer-Pakt-Staaten. Danach glaubt kaum noch jemand an eine Reform des Systems von innen." },
      { year: 1980, title: "Gründung der Solidarność", text: "Auf der Danziger Werft entsteht die erste unabhängige Gewerkschaft im Ostblock. Binnen eines Jahres hat sie fast zehn Millionen Mitglieder." },
      { year: 1989, title: "Das Jahr der Umbrüche", text: "Halbfreie Wahlen in Polen im Juni, das Loch im Eisernen Vorhang in Ungarn im Sommer, die Samtene Revolution in Prag im November. Der Mauerfall ist Teil einer Kette, nicht ihr Anfang." }
    ]
  },
  "Levante": {
    color: "#a06a2e",
    events: [
      { year: -9000, title: "Jericho", text: "Mauer und Turm der frühen Siedlung entstehen Jahrtausende vor jeder Schrift. Wozu sie dienten – Verteidigung, Hochwasserschutz, Repräsentation – ist bis heute offen." },
      { year: -1400, title: "Ugarit und das Alphabet", text: "In der Hafenstadt an der syrischen Küste wird eine Keilschrift mit rund dreißig Zeichen benutzt. Der Schritt von hunderten Zeichen zu wenigen macht Schrift lernbar für Nichtspezialisten." },
      { year: -1000, title: "Phönizische Städte und israelitische Königreiche", text: "Tyros und Sidon gründen Handelsniederlassungen bis Spanien. Über Ausdehnung und Macht der israelitischen Königreiche wird zwischen Bibelwissenschaft und Archäologie bis heute gestritten." },
      { year: -586, title: "Zerstörung Jerusalems und Babylonisches Exil", text: "Der Tempel wird zerstört, die Oberschicht verschleppt. Im Exil entsteht ein Großteil dessen, was später die hebräische Bibel bildet – eine Religion überlebt den Verlust ihres Zentrums." },
      { year: -333, title: "Alexander und die hellenistische Zeit", text: "Griechische Sprache und Stadtkultur überlagern die Region. Der Konflikt zwischen Anpassung und Bewahrung führt 167 v. Chr. zum Makkabäeraufstand." },
      { year: 70, title: "Zerstörung des Zweiten Tempels", text: "Rom schlägt den jüdischen Aufstand nieder. Aus der Tempelreligion wird das rabbinische Judentum – Lehrhaus und Text ersetzen den Opferkult." },
      { year: 135, title: "Bar-Kochba-Aufstand niedergeschlagen", text: "Rom benennt die Provinz in Syria Palaestina um und verbietet Juden Jerusalem. Der Name Palästina in seiner heutigen Verwendung geht auf diesen Verwaltungsakt zurück." },
      { year: 636, title: "Schlacht am Jarmuk", text: "Die muslimischen Heere besiegen Byzanz; die Levante wird binnen weniger Jahre islamisch beherrscht. Christliche und jüdische Gemeinden bleiben, unter eigenem Recht und mit Sondersteuer." },
      { year: 691, title: "Der Felsendom", text: "Der älteste erhaltene islamische Monumentalbau entsteht auf dem Tempelberg. Der Ort ist damit für drei Religionen zentral – die Grundlage eines Konflikts, der bis in die Gegenwart reicht." },
      { year: 1099, title: "Die Kreuzfahrer nehmen Jerusalem", text: "Die Eroberung geht mit einem Massaker an Muslimen und Juden einher. Für die islamische Welt war der Vorgang zunächst ein Randereignis; zum Symbol wurde er erst später." },
      { year: 1187, title: "Saladin gewinnt Jerusalem zurück", text: "Nach dem Sieg bei Hattin nimmt er die Stadt weitgehend ohne Blutvergießen ein. Der Kontrast zu 1099 prägte seinen Ruf auch in Europa." },
      { year: 1291, title: "Fall von Akkon", text: "Der letzte Kreuzfahrerstützpunkt fällt. Zwei Jahrhunderte lateinische Herrschaft enden – hinterlassen aber dauerhafte Handelsbeziehungen zwischen Europa und dem Osten." },
      { year: 1516, title: "Osmanische Herrschaft beginnt", text: "Vier Jahrhunderte lang gehört die Levante zum Osmanischen Reich. Das Millet-System gewährt Religionsgemeinschaften eigene Rechtsprechung – Ordnung durch Trennung, nicht durch Gleichheit." },
      { year: 1860, title: "Bürgerkrieg im Libanongebirge", text: "Kämpfe zwischen Drusen und Maroniten führen zu europäischer Intervention und einer autonomen Provinz. Die konfessionelle Aufteilung politischer Ämter im Libanon hat hier ihren Ursprung." },
      { year: 1916, title: "Das Sykes-Picot-Abkommen", text: "Britannien und Frankreich teilen die Region geheim in Einflusszonen – während sie den Arabern zugleich einen eigenen Staat in Aussicht stellen. Die Doppelzüngigkeit belastet das Verhältnis bis heute." },
      { year: 1917, title: "Die Balfour-Erklärung", text: "Britannien befürwortet eine nationale Heimstätte für das jüdische Volk in Palästina und will zugleich die Rechte der bestehenden Bevölkerung wahren. Beide Zusagen ließen sich nicht gleichzeitig einlösen." },
      { year: 1920, title: "Völkerbundmandate", text: "Frankreich erhält Syrien und Libanon, Britannien Palästina und Transjordanien. Die heutigen Staatsgrenzen der Region stammen im Kern aus dieser Zeit." },
      { year: 1936, title: "Der Arabische Aufstand in Palästina", text: "Drei Jahre Erhebung gegen die Mandatsmacht und die jüdische Einwanderung. Die Niederschlagung schwächt die palästinensische Führung nachhaltig." },
      { year: 1947, title: "Der UN-Teilungsplan", text: "Die Vollversammlung empfiehlt zwei Staaten. Die jüdische Seite stimmt zu, die arabische lehnt ab – für sie war die Aufteilung eines mehrheitlich arabisch bewohnten Landes nicht hinnehmbar." },
      { year: 1948, title: "Staatsgründung Israels und Nakba", text: "Israel erklärt seine Unabhängigkeit, benachbarte Staaten greifen an. Im Krieg fliehen oder werden vertrieben nach UN-Erhebungen von 1949 und 1950 zwischen 711.000 und 726.000 Palästinenser. Dasselbe Jahr ist für die eine Seite Gründung, für die andere Katastrophe." },
      { year: 1967, title: "Der Sechstagekrieg", text: "Israel besetzt Westjordanland, Gaza, Golan und Sinai. Aus einem zwischenstaatlichen Konflikt wird zusätzlich einer über Besatzung – die Kernfrage der folgenden Jahrzehnte." },
      { year: 1975, title: "Bürgerkrieg im Libanon", text: "Fünfzehn Jahre Krieg mit über 100.000 Toten, ausländischen Interventionen und Massakern auf mehreren Seiten. Der Staat erholt sich davon bis heute nicht vollständig." },
      { year: 1979, title: "Frieden zwischen Ägypten und Israel", text: "Der erste Friedensvertrag Israels mit einem arabischen Staat. Sadat bezahlt ihn 1981 mit dem Leben." },
      { year: 1993, title: "Die Oslo-Abkommen", text: "Gegenseitige Anerkennung und Selbstverwaltung als Zwischenschritt. Die Kernfragen – Grenzen, Jerusalem, Flüchtlinge, Siedlungen – wurden vertagt und blieben ungelöst." },
      { year: 2011, title: "Aufstand und Krieg in Syrien", text: "Aus Protesten wird ein Krieg mit hunderttausenden Toten und Millionen Vertriebenen – die größte Fluchtbewegung seit dem Zweiten Weltkrieg." }
    ]
  },
  "Arabische Halbinsel": {
    color: "#6b6b2e",
    events: [
      { year: -800, title: "Die Weihrauchstraße", text: "Saba und andere südarabische Reiche leben vom Handel mit Weihrauch und Myrrhe. Ihre Bewässerungsanlagen, darunter der Damm von Marib, gehören zu den größten Bauwerken der Antike." },
      { year: 570, title: "Mekka als Handels- und Kultort", text: "Die Stadt liegt an der Karawanenroute und beherbergt ein überregionales Heiligtum. Die Verbindung von Handel und Pilgerwesen bestand vor dem Islam und wurde von ihm übernommen." },
      { year: 622, title: "Die Hidschra", text: "Mohammeds Auswanderung nach Medina ist der Beginn der islamischen Zeitrechnung – gezählt wird nicht ab seiner Geburt oder Berufung, sondern ab der Gründung eines Gemeinwesens." },
      { year: 632, title: "Tod Mohammeds", text: "Binnen weniger Jahre ist die Halbinsel geeint. Der Streit um die Nachfolge führt zur bis heute wirksamen Trennung zwischen Sunniten und Schiiten." },
      { year: 661, title: "Die Umayyaden verlegen die Hauptstadt nach Damaskus", text: "Das Zentrum der islamischen Welt wandert nach Norden. Die Halbinsel wird für tausend Jahre religiöses Herz und politische Peripherie zugleich." },
      { year: 1517, title: "Die Osmanen übernehmen den Hedschas", text: "Der Sultan wird Schutzherr von Mekka und Medina – ein Titel, der seine Autorität in der gesamten islamischen Welt begründet." },
      { year: 1744, title: "Das Bündnis von Diriyya", text: "Der Fürst Muhammad ibn Saud und der Rechtsgelehrte Muhammad ibn Abd al-Wahhab verbinden Herrschaft und Lehre. Die Verbindung von Dynastie und religiöser Reformbewegung trägt bis heute." },
      { year: 1818, title: "Zerstörung des ersten saudischen Staates", text: "Osmanisch-ägyptische Truppen schleifen Diriyya. Die Bewegung überlebt und formiert sich im Landesinneren neu." },
      { year: 1902, title: "Ibn Saud nimmt Riad", text: "Mit einer kleinen Schar erobert er die Stadt zurück. Es folgen dreißig Jahre Feldzüge, an deren Ende ein Staat steht." },
      { year: 1916, title: "Die Arabische Revolte", text: "Der Scherif von Mekka erhebt sich mit britischer Unterstützung gegen die Osmanen. Die zugesagte arabische Einheit kam nie – stattdessen kamen die Mandatsgrenzen." },
      { year: 1932, title: "Gründung des Königreichs Saudi-Arabien", text: "Der Staat trägt den Namen seiner Herrscherfamilie – weltweit fast einzigartig. Er ist zu diesem Zeitpunkt bitterarm und lebt von Pilgerabgaben." },
      { year: 1938, title: "Erdölfund bei Dammam", text: "Nach Jahren erfolgloser Bohrungen wird man fündig. Binnen einer Generation verwandelt sich die Wirtschaftsgrundlage der gesamten Region." },
      { year: 1945, title: "Das Treffen auf der USS Quincy", text: "Roosevelt und Ibn Saud vereinbaren Öl gegen Sicherheit. Diese Grundformel prägt die amerikanische Nahostpolitik bis heute." },
      { year: 1948, title: "Entdeckung des Ghawar-Feldes", text: "Das größte konventionelle Ölfeld der Erde. Wie viel noch darin steckt, war jahrzehntelang Staatsgeheimnis – belastbare Zahlen gibt es erst seit 2019." },
      { year: 1960, title: "Gründung der OPEC", text: "Fünf Förderstaaten schließen sich zusammen, um Preise und Fördermengen selbst zu bestimmen. 1973 zeigt sich, welche Macht darin liegt." },
      { year: 1971, title: "Unabhängigkeit der Golfstaaten", text: "Britannien zieht sich östlich von Suez zurück. Die Vereinigten Arabischen Emirate, Katar und Bahrain entstehen als eigenständige Staaten." },
      { year: 1979, title: "Besetzung der Großen Moschee in Mekka", text: "Bewaffnete Aufständische halten das Heiligtum zwei Wochen. Die saudische Führung antwortet mit weitreichenden Zugeständnissen an die religiösen Gelehrten – ein Wendepunkt hin zu größerer Strenge." },
      { year: 1990, title: "Irak besetzt Kuwait", text: "Die anschließende internationale Militäraktion bringt amerikanische Truppen dauerhaft auf die Halbinsel – ein Umstand, den islamistische Bewegungen zur Rechtfertigung ihres Terrors heranzogen." },
      { year: 2015, title: "Krieg im Jemen", text: "Eine von Saudi-Arabien geführte Koalition greift ein. Die Vereinten Nationen sprechen jahrelang von einer der schwersten humanitären Krisen der Welt." },
      { year: 2016, title: "Vision 2030", text: "Saudi-Arabien kündigt den Umbau weg vom Öl an. Ob eine Rentenökonomie sich aus eigener Kraft in eine andere Wirtschaftsform verwandeln kann, ist historisch weitgehend unerprobt." }
    ]
  }
};

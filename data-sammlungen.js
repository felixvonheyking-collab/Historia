...
const SCHLUESSELMOMENTE = [
  {"year":-3200,"title":"Erfindung der Schrift","category":"Erfindung","text":"Mit der Keilschrift und den Hieroglyphen wird Wissen erstmals dauerhaft speicher- und übertragbar – die Voraussetzung für Verwaltung, Recht, Wissenschaft und Geschichtsschreibung selbst.","vertiefung":"erfindung-schrift","thema":"kommunikation"},
  {"year":-508,"title":"Geburt der Demokratie in Athen","category":"Politischer Umbruch","text":"Kleisthenes' Reformen schaffen erstmals ein politisches System, in dem Bürger direkt über ihr Gemeinwesen entscheiden – ein Ideal, das über zwei Jahrtausende später weltweit wirkt.","vertiefung":"athener-demokratie","thema":"recht"},
  ...
  {"year":476,"title":"Untergang Westroms","category":"Politischer Umbruch","text":"Das Ende der antiken Ordnung in Westeuropa leitet Jahrhunderte politischer Zersplitterung ein, aus denen die heutigen europäischen Nationen langsam hervorgehen.","vertiefung":"ende-westrom"},
  {"year":1347,"title":"Der Schwarze Tod","category":"Katastrophe","text":"Ein Drittel der europäischen Bevölkerung stirbt innerhalb weniger Jahre – der dadurch entstehende Arbeitskräftemangel verschiebt langfristig die Machtverhältnisse zwischen Adel und einfachem Volk.","vertiefung":"schwarzer-tod","thema":"medizin"},
  {"year":1453,"title":"Fall Konstantinopels","category":"Wendepunkt im Krieg","text":"Mit dem Ende des Byzantinischen Reiches verschiebt sich die Machtbalance zwischen Orient und Okzident endgültig – zugleich fliehen griechische Gelehrte nach Westeuropa und befeuern die Renaissance.","vertiefung":"fall-konstantinopel"},
  {"year":1492,"title":"Kolumbus erreicht Amerika","category":"Wendepunkt","text":"Zwei bis dahin getrennte Weltteile treten in dauerhaften Kontakt – mit enormen Folgen für Handel, Migration, Krankheiten und Machtverhältnisse, aber auch verheerenden Folgen für indigene Bevölkerungen.","vertiefung":"columbian-exchange"},
  {"year":1517,"title":"Beginn der Reformation","category":"Religion","text":"Luthers Thesen spalten die westliche Christenheit dauerhaft und lösen jahrhundertelange religiöse und politische Konflikte in Europa aus.","vertiefung":"reformation","thema":"kommunikation"},
  ...
  {"year":1914,"title":"Ausbruch des Ersten Weltkriegs","category":"Wendepunkt im Krieg","text":"Ein regionales Attentat löst durch ein Bündnisgeflecht einen globalen Krieg aus, der vier Großreiche zerstört und die politische Landkarte des 20. Jahrhunderts neu zeichnet.","vertiefung":"julikrise"},
  {"year":1917,"title":"Russische Revolution","category":"Politischer Umbruch","text":"Erstmals übernimmt eine kommunistische Bewegung dauerhaft die Staatsmacht – prägt Weltpolitik und Ideologiekonflikte für das gesamte 20. Jahrhundert.","vertiefung":"russische-revolution"},
  {"year":1929,"title":"Weltwirtschaftskrise","category":"Katastrophe","text":"Entscheidend war nicht der Kurssturz, sondern seine Übertragung: Der Goldstandard band die Währungen aneinander, sodass Notenbanken mit Zinserhöhungen gegensteuern mussten und die Krise damit vertieften. Wer den Goldstandard zuerst verließ, erholte sich zuerst – Großbritannien ab 1931, die USA erst ab 1933.","vertiefung":"weltwirtschaftskrise","thema":"geld"},
  {"year":1945,"title":"Erster Einsatz von Atomwaffen","category":"Wendepunkt im Krieg","text":"Die Abwürfe auf Hiroshima und Nagasaki beenden den Zweiten Weltkrieg und eröffnen zugleich das nukleare Zeitalter mit permanenter Auslöschungsgefahr.","vertiefung":"zweiter-weltkrieg","thema":"energie"},
  ...
  {"year":1989,"title":"Fall der Berliner Mauer","category":"Politischer Umbruch","text":"Friedliche Massenproteste beenden die deutsche und europäische Teilung und läuten das Ende des Kalten Krieges ein.","vertiefung":"mauerfall"},
  ...
  {"year":-221,"title":"Erste Reichseinigung Chinas","category":"Politischer Umbruch","text":"Qin Shi Huang vereinigt die zerstrittenen chinesischen Reiche gewaltsam und schafft mit einheitlicher Schrift und Verwaltung die Grundlage des chinesischen Staates bis heute.","vertiefung":"qin-einigung"},
  {"year":1204,"title":"Plünderung Konstantinopels durch Kreuzfahrer","category":"Wendepunkt im Krieg","text":"Der Vierte Kreuzzug richtet sich gegen die christliche Schwesterstadt Byzanz statt gegen Muslime – ein Verrat, der Byzanz dauerhaft schwächt und den Fall an die Osmanen 1453 vorbereitet.","vertiefung":"kreuzzuege"},
  {"year":1258,"title":"Mongolische Zerstörung Bagdads","category":"Katastrophe","text":"Die Vernichtung der abbasidischen Hauptstadt beendet abrupt das islamische 'Goldene Zeitalter' der Wissenschaft und gilt als eine der größten kulturellen Katastrophen der Geschichte.","vertiefung":"mongolisches-reich"},
  ...
  {"year":1871,"title":"Deutsche Reichsgründung","category":"Politischer Umbruch","text":"Die Einigung unter preußischer Führung schafft eine neue Großmacht im Zentrum Europas und verändert das europäische Kräftegleichgewicht dauerhaft.","vertiefung":"reichsgruendung"},
  ...
  {"year":1947,"title":"Teilung Indiens","category":"Katastrophe","text":"Die überstürzte Teilung in Indien und Pakistan löst eine der größten Zwangsmigrationen der Geschichte mit hunderttausenden Toten aus.","vertiefung":"teilung-indiens","thema":"migration"},
  {"year":105,"title":"Erfindung des Papiers","category":"Erfindung","text":"Der chinesische Hofbeamte Cai Lun verfeinert die Papierherstellung entscheidend – über Jahrhunderte breitet sich diese Beschreibstoff-Revolution allmählich bis nach Europa aus.","thema":"kommunikation"},
  {"year":868,"title":"Ältestes datiertes gedrucktes Buch","category":"Erfindung","text":"Das chinesische Diamant-Sutra entsteht im Holzdruckverfahren – Jahrhunderte vor Gutenberg, wenn auch ohne bewegliche Lettern.","thema":"kommunikation"},
  ...
  {"year":1088,"title":"Gründung der ersten europäischen Universität","category":"Kultur","text":"Die Universität von Bologna entsteht als älteste durchgehend bestehende Universität Europas – Grundstein institutionalisierter höherer Bildung.","thema":"kommunikation"},
  ...
  {"year":1500,"title":"Der Kolumbianische Austausch","category":"Wendepunkt","text":"Pflanzen, Tiere, Menschen und Krankheiten zirkulieren erstmals massenhaft zwischen der Alten und der Neuen Welt – mit enormen, teils verheerenden ökologischen und demografischen Folgen.","vertiefung":"columbian-exchange","thema":"ernaehrung"},
  ...
  {"year":1796,"title":"Erfindung der Pockenimpfung","category":"Wissenschaft","text":"Edward Jenner entwickelt die erste wissenschaftlich fundierte Impfung der Geschichte – Grundstein der modernen Immunologie und späteren Ausrottung der Pocken.","thema":"medizin"},
  ...
  {"year":1960,"title":"'Afrikanisches Jahr'","category":"Politischer Umbruch","text":"Binnen eines einzigen Jahres erlangen 17 afrikanische Staaten ihre Unabhängigkeit von europäischen Kolonialmächten – Höhepunkt der weltweiten Dekolonisierungswelle.","vertiefung":"dekolonisation"},
  {"year":1969,"title":"Geburtsstunde des Internets (ARPANET)","category":"Erfindung","text":"Die erste Datenverbindung zwischen zwei Universitätscomputern legt den technischen Grundstein für das spätere globale Internet.","thema":"kommunikation"},
  {"year":2003,"title":"Entschlüsselung des menschlichen Genoms","category":"Wissenschaft","text":"Ein internationales Forschungsprojekt kartiert erstmals vollständig die genetische Bauanleitung des Menschen – mit weitreichenden Folgen für Medizin und Biotechnologie.","vertiefung":"doppelhelix","thema":"medizin"},
  {"year":-3000,"category":"Erfindung","text":"Das Rad taucht zunächst nicht im Verkehr auf, sondern als Töpferscheibe. Erst später wird daraus das Wagenrad – eine Erfindung, die den Transport von Lasten und damit Handel und Krieg grundlegend verändert.","title":"Rad und Töpferscheibe","thema":"energie"},
  {"year":-1754,"category":"Politischer Umbruch","title":"Kodex Hammurapi","text":"Der babylonische König lässt Rechtssätze in Stein hauen und öffentlich aufstellen. Entscheidend ist weniger der Inhalt als das Prinzip: Recht wird nachprüfbar, weil es geschrieben und sichtbar ist.","thema":"recht"},
  {"year":-600,"category":"Erfindung","title":"Erfindung der Münze","text":"In Lydien entstehen erste geprägte Münzen aus Elektron. Geld als genormtes, staatlich garantiertes Tauschmittel macht Handel über Vertrauensgrenzen hinweg möglich.","thema":"geld"},
  {"year":105,"category":"Erfindung","title":"Papier in China","text":"Dem Hofbeamten Cai Lun wird die Verbesserung der Papierherstellung zugeschrieben. Über die islamische Welt erreicht das Verfahren erst rund tausend Jahre später Europa.","thema":"kommunikation"},
  {"year":476,"category":"Wendepunkt","title":"Absetzung des letzten Westkaisers","text":"Odoaker setzt Romulus Augustulus ab. Zeitgenossen sahen darin kaum einen Einschnitt – das Datum wurde erst von späteren Historikern zur Epochengrenze erhoben.","vertiefung":"ende-westrom"},
  {"year":622,"category":"Religion","title":"Hidschra","text":"Mohammeds Auswanderung von Mekka nach Medina markiert den Beginn der islamischen Zeitrechnung – ein Kalender, der von einem politischen Neuanfang aus zählt, nicht von einer Geburt.","vertiefung":"islamische-expansion"},
  ...
  {"year":1215,"category":"Politischer Umbruch","title":"Magna Carta","text":"König Johann muss zugestehen, dass auch der Herrscher an Recht gebunden ist – ein Satz, der über Jahrhunderte weiterwirkt, obwohl das Dokument zunächst Adelsinteressen sicherte.","thema":"recht"},
  {"year":1440,"category":"Wissenschaft","title":"Der Buchdruck","text":"Gutenbergs bewegliche Lettern senken den Buchpreis binnen weniger Jahrzehnte um zwei Drittel. Wissen wird erstmals in großer Zahl vergleichbar – und damit überprüfbar.","vertiefung":"buchdruck","thema":"kommunikation"},
  ...
  {"year":1755,"category":"Katastrophe","title":"Erdbeben von Lissabon","text":"Das Beben an Allerheiligen zerstört eine europäische Hauptstadt und erschüttert das theologische Weltbild: Wie lässt sich ein solches Unglück mit einer guten Weltordnung vereinbaren? Die Frage prägt die Aufklärung.","vertiefung":"aufklaerung"},
  {"year":1804,"category":"Politischer Umbruch","title":"Unabhängigkeit Haitis","text":"Aus dem einzigen erfolgreichen Sklavenaufstand der Geschichte geht ein unabhängiger Staat hervor. Die europäischen Mächte und die USA reagieren mit Isolation statt Anerkennung.","vertiefung":"sklavenhandel","thema":"zwangsarbeit"},
  ...
  {"year":1865,"category":"Wissenschaft","title":"Mendels Vererbungsregeln","text":"Der Augustinermönch Gregor Mendel beschreibt an Erbsen die Regeln der Vererbung. Seine Arbeit bleibt 35 Jahre unbeachtet, bis sie um 1900 wiederentdeckt wird.","thema":"ernaehrung"},
  {"year":1867,"category":"Wissenschaft","title":"Antiseptische Chirurgie","text":"Joseph Lister führt Antiseptik in den Operationssaal ein. Zuvor starben Patienten häufiger an der Infektion als am Eingriff.","thema":"medizin"},
  {"year":1893,"category":"Politischer Umbruch","title":"Erstes Frauenwahlrecht","text":"Am 19. September 1893 unterzeichnet der Gouverneur den Electoral Act: Neuseeland ist der erste selbstverwaltete Staat, in dem alle Frauen bei Parlamentswahlen wählen dürfen. Einzelne Territorien hatten Frauen schon früher zugelassen. Zehn Wochen später gingen rund 90.000 Neuseeländerinnen zur Wahl – eine Beteiligung von 82 Prozent und damit höher als bei den Männern.","thema":"recht"},
  ...
  {"year":1928,"category":"Wissenschaft","title":"Entdeckung des Penicillins","text":"Alexander Fleming bemerkt, dass ein Schimmelpilz Bakterien abtötet. Erst der Massenproduktion im Zweiten Weltkrieg verdankt das Antibiotikum seine Wirkung auf die Sterblichkeit.","thema":"medizin"},
  {"year":1945,"category":"Katastrophe","title":"Hiroshima und Nagasaki","text":"Zum ersten und bisher einzigen Mal werden Kernwaffen im Krieg eingesetzt. Seither prägt die Möglichkeit der Selbstauslöschung die internationale Politik.","vertiefung":"zweiter-weltkrieg","thema":"energie"},
  {"year":1948,"category":"Politischer Umbruch","title":"Allgemeine Erklärung der Menschenrechte","text":"Die UN-Generalversammlung verabschiedet einen Text, der Rechte nicht an Staatsangehörigkeit knüpft, sondern an das Menschsein – rechtlich zunächst unverbindlich, politisch wirkmächtig.","thema":"recht"},
  {"year":1953,"category":"Wissenschaft","title":"Struktur der DNA","text":"Watson und Crick beschreiben die Doppelhelix – wesentlich gestützt auf Röntgenaufnahmen von Rosalind Franklin, deren Beitrag lange nicht angemessen gewürdigt wurde.","vertiefung":"doppelhelix","thema":"medizin"},
  {"year":1972,"category":"Wendepunkt","title":"Die Grenzen des Wachstums","text":"Der Bericht an den Club of Rome bringt die Frage, ob unbegrenztes Wachstum auf einem begrenzten Planeten möglich ist, erstmals in die breite Öffentlichkeit.","thema":"energie"},
  {"year":1980,"category":"Wissenschaft","title":"Pocken ausgerottet","text":"Die WHO erklärt die Pocken für ausgerottet – der bislang einzige derartige Erfolg bei einer menschlichen Infektionskrankheit.","thema":"medizin"},
  {"year":1989,"category":"Erfindung","title":"Das World Wide Web","text":"Tim Berners-Lee entwirft am CERN ein System zum Austausch von Forschungsdaten. 1993 gibt das CERN die Software gemeinfrei – die Entscheidung, die seine Ausbreitung ermöglichte.","vertiefung":"world-wide-web","thema":"kommunikation"},
  {"year":1994,"category":"Politischer Umbruch","title":"Ende der Apartheid","text":"Bemerkenswert ist weniger der Machtwechsel als sein Ausbleiben von Rache: Die Wahrheits- und Versöhnungskommission bot Tätern Straffreiheit im Tausch gegen vollständige Aussagen. Ein Verfahren, das seither weltweit nachgeahmt und ebenso lange kritisiert wird – weil Wahrheit an die Stelle von Strafe trat.","vertiefung":"ende-apartheid"},
  {"year":-3300,"title":"Ötzi stirbt am Tisenjoch","category":"Kultur","text":"Der Fund von 1991 liefert die dichteste Momentaufnahme eines Menschenlebens der Kupferzeit – bis hin zu seiner letzten Mahlzeit und dem Pfeil in seiner Schulter."},
  {"year":-1754,"title":"Der Codex Hammurabi","category":"Recht","text":"Die umfangreichste erhaltene Gesetzessammlung der Bronzezeit wird auf eine Stele gemeißelt und öffentlich aufgestellt: Recht wird nachlesbar.","thema":"recht"},
  {"year":-539,"title":"Kyros nimmt Babylon","category":"Herrschaft","text":"Der Kyros-Zylinder verkündet die Rückkehr verschleppter Gruppen – oft als erste Menschenrechtserklärung bezeichnet, tatsächlich ein Text persischer Herrschaftslegitimation."},
  {"year":-44,"title":"Ermordung Caesars","category":"Herrschaft","text":"Der Versuch, die Republik zu retten, beschleunigt ihr Ende: Vierzehn Jahre später ist Rom eine Monarchie."},
  {"year":751,"title":"Schlacht am Talas","category":"Konflikt","text":"Der Vormarsch der Tang nach Westen endet. China zieht sich für ein Jahrtausend aus Zentralasien zurück.","vertiefung":"seidenstrasse"},
  {"year":868,"title":"Das älteste datierte gedruckte Buch","category":"Erfindung","text":"Das chinesische Diamant-Sutra trägt ein Datum und den Vermerk, es sei zur freien Verteilung bestimmt – Druck und Wissensfreiheit treten gemeinsam auf.","thema":"kommunikation"},
  {"year":1206,"title":"Dschingis Khan wird ausgerufen","category":"Herrschaft","text":"Aus rivalisierenden Steppenverbänden wird ein Staat. Innerhalb einer Generation entsteht das größte zusammenhängende Landreich der Geschichte.","vertiefung":"mongolisches-reich"},
  {"year":1324,"title":"Mansa Musas Pilgerfahrt","category":"Wirtschaft","text":"Der Herrscher Malis verschenkt in Kairo so viel Gold, dass dessen Wert dort über Jahre gedrückt bleibt – Westafrika tritt ins europäische Weltbild.","vertiefung":"mali-reich","thema":"geld"},
  {"year":1492,"title":"Ende von Al-Andalus","category":"Herrschaft","text":"Mit dem Fall Granadas endet fast achthundert Jahre islamische Herrschaft in Spanien. Im selben Jahr werden Juden vertrieben und Kolumbus segelt los."},
  {"year":1804,"title":"Haiti wird unabhängig","category":"Herrschaft","text":"Der einzige Staat, der aus einem erfolgreichen Sklavenaufstand hervorgeht – und dafür jahrzehntelang isoliert und mit Reparationen belastet wird.","vertiefung":"sklavenhandel","thema":"zwangsarbeit"},
  {"year":1885,"title":"Die Berliner Konferenz endet","category":"Herrschaft","text":"Europäische Mächte teilen Afrika unter sich auf, ohne dass ein Afrikaner am Tisch sitzt. Die gezogenen Grenzen bestehen weitgehend fort.","vertiefung":"dekolonisation"},
  {"year":1896,"title":"Adwa","category":"Konflikt","text":"Äthiopien schlägt eine europäische Invasionsarmee und bleibt unkolonisiert – ein Bezugspunkt antikolonialer Bewegungen weltweit."},
  {"year":1955,"title":"Die Konferenz von Bandung","category":"Herrschaft","text":"29 Staaten Asiens und Afrikas verständigen sich ohne europäische Beteiligung – die Geburtsstunde des globalen Südens als politischer Größe.","vertiefung":"bandung"},
  {"year":1957,"title":"Ghana wird unabhängig","category":"Herrschaft","text":"Als erste Kolonie südlich der Sahara. Drei Jahre später folgen siebzehn weitere Staaten.","vertiefung":"dekolonisation"},
  {"year":1972,"title":"Der Blick zurück","category":"Kultur","text":"Die Apollo-17-Besatzung fotografiert die Erde als vollständige Kugel. Das Bild wird zum Sinnbild der Umweltbewegung."},
  {"year":1994,"title":"Erste allgemeine Wahlen in Südafrika","category":"Herrschaft","text":"Ein Regime, dessen Ende fast alle für nur gewaltsam möglich hielten, endet am Wahltag.","vertiefung":"ende-apartheid"},
  {"year":2001,"title":"Das menschliche Genom","category":"Wissenschaft","text":"Die erste Rohfassung wird veröffentlicht. Sie zeigt weniger Gene als erwartet – und dass genetische Unterschiede zwischen Menschengruppen geringer sind als innerhalb von ihnen.","vertiefung":"doppelhelix","thema":"medizin"}
];

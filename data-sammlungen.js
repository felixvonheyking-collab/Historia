...
const SCHLUESSELMOMENTE = [
  ...
  {"year":-1754,"title":"Der Codex Hammurabi","category":"Recht","text":"Die umfangreichste erhaltene Gesetzessammlung der Bronzezeit wird auf eine Stele gemeißelt und öffentlich aufgestellt: Recht wird nachlesbar."},
  ...
  {"year":-221,"title":"Chinas erste Reichseinigung","category":"Herrschaft","text":"Qin Shihuangdi vereinheitlicht Schrift, Maße und Achsbreiten. Die Vorstellung eines einheitlichen China überlebt jede spätere Zersplitterung."},
  ...
  {"year":622,"title":"Die Hidschra","category":"Religion","text":"Mohammeds Auswanderung nach Medina wird zum Beginn der islamischen Zeitrechnung – gezählt wird ab der Gründung eines Gemeinwesens, nicht ab einer Geburt."},
  {"year":751,"title":"Schlacht am Talas","category":"Konflikt","text":"Der Vormarsch der Tang nach Westen endet. China zieht sich für ein Jahrtausend aus Zentralasien zurück."},
  {"year":868,"title":"Das älteste datierte gedruckte Buch","category":"Erfindung","text":"Das chinesische Diamant-Sutra trägt ein Datum und den Vermerk, es sei zur freien Verteilung bestimmt – Druck und Wissensfreiheit treten gemeinsam auf."},
  {"year":1088,"title":"Gründung der Universität Bologna","category":"Wissenschaft","text":"Eine Gemeinschaft von Studenten stellt Lehrer an. Aus dieser Rechtsform entsteht die Universität als Institution, die bis heute besteht."},
  {"year":1206,"title":"Dschingis Khan wird ausgerufen","category":"Herrschaft","text":"Aus rivalisierenden Steppenverbänden wird ein Staat. Innerhalb einer Generation entsteht das größte zusammenhängende Landreich der Geschichte."},
  {"year":1324,"title":"Mansa Musas Pilgerfahrt","category":"Wirtschaft","text":"Der Herrscher Malis verschenkt in Kairo so viel Gold, dass dessen Wert dort über Jahre gedrückt bleibt – Westafrika tritt ins europäische Weltbild."},
  ...
  {"year":1543,"title":"Kopernikus und Vesalius","category":"Wissenschaft","text":"Im selben Jahr erscheinen ein Weltbild ohne die Erde im Zentrum und ein Anatomiewerk, das Galen widerlegt. Autorität hört auf, Beweis zu sein."},
  {"year":1648,"title":"Der Westfälische Friede","category":"Herrschaft","text":"Ein Vertragswerk beendet den Dreißigjährigen Krieg und begründet die Vorstellung gleichrangiger souveräner Staaten."},
  {"year":1804,"title":"Haiti wird unabhängig","category":"Herrschaft","text":"Der einzige Staat, der aus einem erfolgreichen Sklavenaufstand hervorgeht – und dafür jahrzehntelang isoliert und mit Reparationen belastet wird."},
  {"year":1848,"title":"Das Revolutionsjahr","category":"Herrschaft","text":"Von Palermo bis Berlin erheben sich Bürger fast gleichzeitig. Die Revolutionen scheitern kurzfristig und setzen ihre Forderungen langfristig durch."},
  {"year":1885,"title":"Die Berliner Konferenz endet","category":"Herrschaft","text":"Europäische Mächte teilen Afrika unter sich auf, ohne dass ein Afrikaner am Tisch sitzt. Die gezogenen Grenzen bestehen weitgehend fort."},
  ...
  {"year":1905,"title":"Tsushima","category":"Konflikt","text":"Erstmals besiegt eine asiatische Macht eine europäische Großmacht in einer Seeschlacht. Die Wirkung auf Kolonialgebiete ist enorm."},
  {"year":1955,"title":"Die Konferenz von Bandung","category":"Herrschaft","text":"29 Staaten Asiens und Afrikas verständigen sich ohne europäische Beteiligung – die Geburtsstunde des globalen Südens als politischer Größe."},
  {"year":1957,"title":"Ghana wird unabhängig","category":"Herrschaft","text":"Als erste Kolonie südlich der Sahara. Drei Jahre später folgen siebzehn weitere Staaten."},
  ...
  {"year":1994,"title":"Erste allgemeine Wahlen in Südafrika","category":"Herrschaft","text":"Ein Regime, dessen Ende fast alle für nur gewaltsam möglich hielten, endet am Wahltag."},
  {"year":2001,"title":"Das menschliche Genom","category":"Wissenschaft","text":"Die erste Rohfassung wird veröffentlicht. Sie zeigt weniger Gene als erwartet – und dass genetische Unterschiede zwischen Menschengruppen geringer sind als innerhalb von ihnen."}
];

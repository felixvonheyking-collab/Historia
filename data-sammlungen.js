...
const SURPRISING_FACTS = [
 ...
 "Die Universität al-Azhar in Kairo (970) und die Universität Bologna (1088) nahmen Studenten auf, als Oxford noch nicht existierte — und alle drei unterrichten heute noch.",
 "Der letzte lebende Veteran des Amerikanischen Bürgerkriegs starb 1956, im Jahr, in dem Elvis Presley seinen ersten Nummer-eins-Hit hatte.",
 "Als die Pyramiden von Gizeh gebaut wurden, gab es in Europa noch Mammuts — auf der Wrangelinsel lebten sie bis etwa 1700 v. Chr.",
 "Oxford nahm Studenten auf, bevor das Aztekenreich gegründet wurde.",
 "Die französische Regierung zahlte bis 1893 Renten an Veteranen von Napoleons Feldzügen; der letzte Empfänger starb im Jahr der ersten Filmvorführung der Brüder Lumière.",
 "Die Verwendung von Mumien als Arzneimittel war in Europa bis ins 18. Jahrhundert verbreitet — Apotheken führten Mumia als Pulver.",
 "Im römischen Reich wurde Urin gesammelt und versteuert: Er diente Wäschern als Reinigungsmittel, weil das darin entstehende Ammoniak Fett löst.",
 "Der Begriff Salär kommt vom lateinischen Wort für Salz; ob römische Soldaten tatsächlich in Salz bezahlt wurden, ist allerdings nicht belegt.",
 "Die Wikinger erreichten Nordamerika rund 470 Jahre vor Kolumbus; das Jahr 1021 ist über einen Sonnensturm in Jahresringen exakt datiert.",
 "Als Abraham Lincoln erschossen wurde, war die Photographie 39 Jahre alt — es existieren Aufnahmen seiner Beerdigung.",
 "Die Oktoberrevolution fand nach heutigem Kalender im November statt: Russland benutzte 1917 noch den julianischen Kalender.",
 "Der Buchdruck erreichte Europa etwa 400 Jahre nach der Erfindung beweglicher Metallletternen in Korea.",
 "In Australien starben im Emu-Krieg von 1932 keine Menschen — die eingesetzten Soldaten gaben nach Wochen auf, weil die Vögel sich zerstreuten.",
 "Der Vesuv hat seit dem Ausbruch von 79 mindestens dreißig weitere Male ausgebrochen; der letzte war 1944, mitten im Krieg, und amerikanische Bomber verloren dabei Flugzeuge durch Ascheschäden.",
 "Karl der Große konnte lesen, aber nach dem Bericht seines Biographen Einhard nie richtig schreiben lernen — er übte im Bett mit einer Tafel.",
 "Der römische Kaiser Claudius schrieb eine Geschichte der Etrusker in 20 Bänden. Sie ist vollständig verloren; er ist damit der einzige Mensch, der ein Volk beschrieb, dessen Sprache heute niemand mehr flüssig lesen kann.",
 "Die Bibliothek von Timbuktu enthielt im 16. Jahrhundert nach Berichten von Reisenden mehr Handschriften als viele europäische Universitäten; hunderttausende Manuskripte existieren noch, teils in Privatbesitz.",
 "Das Osmanische Reich bestand länger, als es die Vereinigten Staaten heute gibt: 623 Jahre.",
 "Königin Elizabeth II. lebte zur Zeit von 15 britischen Premierministern, beginnend mit Winston Churchill, geboren 1874.",
 "Bevor Wecker verbreitet waren, gab es in Industriestädten Klopfer, die für Geld gegen Fenster klopften; der Beruf hielt sich in England bis in die 1970er Jahre.",
 "Die Guillotine wurde in Frankreich bis 1977 eingesetzt; die Todesstrafe wurde dort 1981 abgeschafft.",
 "Das Wort Quarantäne kommt vom italienischen quaranta giorni, vierzig Tage — der Frist, die Venedig und Dubrovnik Schiffen in Pestzeiten auferlegten.",
 "Die ersten Rolltreppen wurden auf Weltausstellungen als Vergnügungsattraktion vorgeführt, mit Eintrittsgeld.",
 "Napoleons Rückzug aus Russland kostete rund 90 Prozent seiner Armee; ein einzelner Feldzug vernichtete mehr Menschen, als Frankreichs Hauptstadt damals Einwohner hatte.",
 "Die Sowjetunion und die USA arbeiteten mitten im Kalten Krieg bei der Ausrottung der Pocken zusammen — der Vorschlag kam 1958 von einem sowjetischen Virologen, die Leitung hatte ein Amerikaner.",
 "In London gab es 1854 keinen Beweis für die Theorie, dass Cholera durch Wasser übertragen wird — John Snow überzeugte die Behörden mit einer Karte, auf der er die Todesfälle um eine einzige Wasserpumpe einzeichnete.",
 "Die erste Ampel der Welt stand 1868 in London, war gasbetrieben und explodierte nach wenigen Wochen; der bedienende Polizist wurde verletzt.",
 "Der Suezkanal war zwischen 1967 und 1975 gesperrt; vierzehn Frachtschiffe blieben acht Jahre im Kanal eingeschlossen und wurden wegen des Wüstenstaubs auf den Decks die Gelbe Flotte genannt.",
 "Der Nordpol war 1909 Ziel zweier konkurrierender Expeditionen, deren beide Anspruchsteller heute als unbestätigt gelten; die erste zweifelsfrei belegte Ankunft am geographischen Nordpol über das Eis erfolgte 1968 bis 1969.",
 "Der höchste Berg der Erde ist je nach Messung ein anderer: Everest nach Meereshöhe, Chimborazo nach Entfernung zum Erdmittelpunkt, Mauna Kea nach Höhe über dem Fuß.",
 "Der letzte Brief, den Franz Kafka schrieb, betraf eine Bitte, seine Werke zu verbrennen; sein Freund Max Brod veröffentlichte sie stattdessen — deshalb existiert Der Prozess.",
 "Bis in die 1970er Jahre wurde in mehreren europäischen Ländern der Sommerzeitwechsel abgeschafft und wieder eingeführt; die durchgehende Regelung in der EU gilt erst seit 1980.",
 "Die Sklaverei war 1981 in Mauretanien noch nicht strafbar; ein Gesetz mit Strafandrohung kam erst 2007.",
 "Der Papst hatte bis 1929 keinen eigenen Staat: Der Kirchenstaat war 1870 im italienischen Einigungskrieg untergegangen, die Vatikanstadt entstand durch die Lateranverträge.",
 "Bei der Volkszählung im Römischen Reich zur Zeit des Augustus wurden nur Bürger und ihre Familien erfasst; wie viele Menschen tatsächlich im Reich lebten, ist bis heute eine Schätzfrage zwischen 45 und 100 Millionen.",
 "Die ältesten erhaltenen Hosen der Welt sind rund 3.000 Jahre alt, wurden im Tarim-Becken gefunden und sind aus Wolle gewebt — mit Schrittstück für das Reiten.",
 "Das älteste bekannte Kundenbeschwerdeschreiben ist eine babylonische Tontafel von etwa 1750 v. Chr.: Ein Nanni beschwert sich bei einem Kupferhändler namens Ea-Nasir über minderwertige Ware.",
 "In Ea-Nasirs Haus in Ur wurden mehrere solche Beschwerden gefunden — er hatte sie offenbar aufbewahrt.",
 "Der erste Fußgängerüberweg der Welt lag in Pompeji: erhöhte Trittsteine über die Straße, weil Abwasser und Regenwasser durch die Fahrbahn liefen.",
 "Die längste Belagerung der Geschichte war vermutlich die von Ceuta (1694–1727), 33 Jahre — sie endete ohne Eroberung.",
 "Der Schwarze Tod erreichte Island erst 1402, ein halbes Jahrhundert nach dem Kontinent, und tötete dort geschätzt die Hälfte der Bevölkerung, obwohl die Insel keine Ratten hatte.",
 "Das Wort Boykott stammt von Charles Boycott, einem Gutsverwalter in Irland, den Pächter 1880 gesellschaftlich isolierten; sein Name wurde binnen Monaten in mehrere Sprachen übernommen.",
 "In Rom war das Tragen der Toga für Bürger vorgeschrieben und für Nichtbürger verboten — Kleidung war Rechtsstatus.",
 "Die erste dokumentierte Arbeitsniederlegung fand um 1157 v. Chr. in Ägypten statt: Arbeiter der Königsgräber legten die Werkzeuge nieder, weil ihre Getreiderationen ausblieben.",
 "Der Kalender der Französischen Revolution hatte Monate mit Namen wie Nebelmonat und Hitzemonat, Zehntagewochen und 1793 bis 1805 offizielle Geltung; die Zehntagewoche war beim Volk unbeliebt, weil ein Ruhetag pro zehn statt pro sieben Tage anfiel.",
 "Die Tulpenmanie von 1637 in den Niederlanden gilt als erste Spekulationsblase; die höchsten überlieferten Preise für eine einzelne Zwiebel entsprachen mehreren Jahreslöhnen eines Handwerkers. Wie verbreitet der Handel wirklich war, ist unter Wirtschaftshistorikern umstritten.",
 "Die Glocken vieler europäischer Kirchen wurden im Ersten und Zweiten Weltkrieg zu Munition eingeschmolzen; in manchen Türmen hängen deshalb Glocken aus Stahl oder Gusseisen.",
 "Der Suezkanal war die zweite Trasse dieser Art: Bereits die Pharaonen und später die Perser und Römer betrieben einen Kanal zwischen Nil und Rotem Meer.",
 "Die ersten Streichhölzer entzündeten sich so unkontrolliert, dass Anleitungen empfahlen, sie in einem Sandpapierbogen zusammenzudrücken und wegzuhalten.",
 "Der Phosphor in frühen Streichhölzern verursachte bei Arbeiterinnen Knochenschwund im Kiefer; der Londoner Streik der Streichholzmädchen 1888 gehört zu den ersten erfolgreichen Arbeitskämpfen von Frauen.",
 "Bis 1858 wurden Briefe in Großbritannien überwiegend vom Empfänger bezahlt — die Briefmarke verschob die Zahlung zum Absender und machte Massenpost erst möglich.",
 "Die Titanic hatte für den Fall eines Untergangs eine vorschriftsmäßige Anzahl Rettungsboote — die Vorschrift richtete sich nach der Tonnage und war 1894 geschrieben worden, als die größten Schiffe ein Viertel so groß waren.",
 "Der erste Verkehrstote durch ein Automobil in Großbritannien war 1896 eine Fußgängerin; der Untersuchungsrichter sagte, so etwas dürfe nie wieder vorkommen.",
 "In der Antarktis wurde 1978 das erste Kind geboren — Argentinien flog eine schwangere Frau ein, um Gebietsansprüche zu stützen.",
 "Der kälteste je gemessene natürliche Ort der Erde liegt in der Antarktis bei −89,2 Grad, gemessen 1983 an der sowjetischen Station Wostok.",
 "Bis 1884 hatte jede Stadt ihre eigene Zeit; erst die Eisenbahn erzwang Zeitzonen, weil Fahrpläne sonst unmöglich waren.",
 "Die Uhr am Bahnhof war lange die einzige verlässliche Uhr einer Stadt — private Uhren wurden nach ihr gestellt.",
 "Der Panamakanal kostete beim französischen Versuch schätzungsweise 22.000 Menschenleben, überwiegend durch Malaria und Gelbfieber; der amerikanische Bau gelang erst, nachdem die Übertragung durch Mücken bekannt war.",
 "Die Frau, die 1849 als erste Ärztin in den USA einen Doktortitel erhielt — Elizabeth Blackwell — war von der Hochschule als Scherz zugelassen worden: Die Studenten hatten über ihren Antrag abstimmen dürfen und sie zum Spaß angenommen.",
 "Der Reichstag brannte 1933; das heutige Gebäude wurde erst 1999 wieder Parlamentssitz — 66 Jahre Unterbrechung.",
 "Die Berliner Mauer stand 10.315 Tage. Am 5. Februar 2018 war sie länger weg als sie gestanden hatte.",
 "In Japan gab es zwischen 1639 und 1853 ein Ausreiseverbot für eigene Staatsbürger; wer das Land verließ und zurückkam, riskierte die Todesstrafe.",
 "Die längste diplomatische Beziehung zwischen zwei heutigen Staaten ist die zwischen Portugal und England: Der Vertrag von Windsor stammt von 1386 und wurde nie gekündigt.",
 "Der Papyrus, aus dem das Wort Papier stammt, war noch bis ins 11. Jahrhundert in Gebrauch — die päpstliche Kanzlei benutzte ihn länger als jede andere Behörde Europas.",
 "Als Rom 410 geplündert wurde, war die Stadt seit über einem Jahrhundert nicht mehr Regierungssitz; der Kaiser saß in Ravenna.",
 "Der Titel Cäsar überlebte das Römische Reich um über 1400 Jahre: in Kaiser und in Zar, bis 1917 und 1918.",
 "Der erste bekannte Streik von Sklaven, der eine Verhandlung erzwang, ist aus Rom nicht überliefert — Rom verhandelte nie. Der einzige Fall, in dem eine Sklavenarmee zwei Jahre unbesiegt blieb, war der des Spartacus.",
 "In der spanischen Kolonialverwaltung existierte eine Behörde, die geheime Karten der Seewege führte; das Padrón Real war Staatsgeheimnis, und Kopieren stand unter Todesstrafe.",
 "Die Kartoffelfäule, die Irland 1845 traf, war derselbe Erreger, der schon Jahre vorher in Nordamerika auftrat — der Transport ging über Schiffe mit Saatgut.",
 "Irland hat heute weniger Einwohner als 1841: Hungersnot und Auswanderung halbierten die Bevölkerung, und sie hat sich nie erholt.",
 "Der Schiefe Turm von Pisa begann sich bereits während des Baus zu neigen; die oberen Stockwerke wurden deshalb schräg aufgesetzt, um gegenzusteuern — der Turm ist leicht gekrümmt.",
 "Bei der Restaurierung 1990 bis 2001 wurde der Turm um 44 Zentimeter aufgerichtet und gilt seither für mindestens 200 Jahre als stabil.",
 "Die Sixtinische Kapelle wurde von Michelangelo im Stehen gemalt, nicht liegend; er beschrieb die Haltung in einem erhaltenen Gedicht mit dem Bild eines Kropfes am Hals.",
 "Die Stadt Konstantinopel wurde in ihrer Geschichte mehr als zwanzig Mal belagert und nur zwei Mal erobert: 1204 von Kreuzfahrern und 1453 von den Osmanen.",
 "Die Hagia Sophia war 916 Jahre Kirche, 481 Jahre Moschee, 86 Jahre Museum und ist seit 2020 wieder Moschee.",
 "Die Kuppel der Hagia Sophia stürzte 558 ein, 21 Jahre nach der Einweihung; die heutige ist die zweite Konstruktion, flacher gebaut.",
 "Als das Kolosseum eröffnet wurde, war die Cheopspyramide bereits 2.600 Jahre alt.",
 "Der Kompass wurde in China zunächst nicht zum Navigieren benutzt, sondern zum Ausrichten von Gebäuden und Gräbern nach geomantischen Regeln.",
 "Das Schießpulver entstand vermutlich bei alchemistischen Versuchen zur Verlängerung des Lebens — die Ironie ist in chinesischen Texten selbst festgehalten.",
 "Die ältesten bekannten Musikinstrumente sind Flöten aus Vogelknochen und Mammutelfenbein aus dem Schwäbischen Jura, rund 40.000 Jahre alt.",
 "Die Höhlenmalereien von Chauvet sind mit etwa 36.000 Jahren doppelt so alt wie die von Lascaux — und zeigen Nashörner und Löwen, die es damals in Frankreich gab.",
 "In Göbekli Tepe wurden monumentale Steinkreise errichtet, bevor es Ackerbau, Töpferei oder Metall gab — die Anlage ist rund 11.500 Jahre alt.",
 "Die Bewohner von Göbekli Tepe verfüllten ihre Anlagen absichtlich mit Schutt; ohne diese Verfüllung wäre nichts erhalten geblieben.",
 "Bis zur Erfindung der Uhr mit Minutenzeiger im 16. Jahrhundert gab es für die meisten Menschen keinen Grund, eine Minute zu kennen.",
 "Die Woche ist die einzige gängige Zeiteinheit ohne astronomische Grundlage — Tag, Monat und Jahr folgen Himmelskörpern, die Sieben-Tage-Woche einer Überlieferung.",
 "Der Kalender, den fast die ganze Welt benutzt, wurde von einem Papst eingeführt und von der Sowjetunion, der Türkei und China aus praktischen Gründen übernommen.",
 "Die Datumsgrenze verläuft absichtlich krumm: Kiribati verschob sie 1995, um im ganzen Staat denselben Tag zu haben.",
 "Der Staat, der am längsten ohne Unterbrechung dieselbe Verfassung hat, ist San Marino: Die Statuten von 1600 gelten in Teilen bis heute.",
 "Island hat mit dem Althing von 930 das älteste noch bestehende Parlament der Welt — es wurde allerdings zwischen 1799 und 1845 unterbrochen.",
 "Das Wort Vandalismus wurde 1794 von einem französischen Bischof geprägt, um Zerstörungen der Revolution zu benennen — die Vandalen selbst hatten Rom 455 vergleichsweise geordnet geplündert.",
 "Die Redewendung von der Büchse der Pandora beruht auf einem Übersetzungsfehler: Im griechischen Text ist es ein großes Vorratsgefäß, ein Pithos. Erasmus schrieb im 16. Jahrhundert pyxis, Büchse.",
 "Der erste Tunnel unter einem befahrenen Fluss war der Themse-Tunnel von 1843; er wurde mit einem Schildvortrieb gebaut, den Marc Brunel vom Bohrmuschel-Prinzip abgeleitet hatte.",
 "Die Londoner U-Bahn fuhr ab 1863 mit Dampflokomotiven; die Tunnel hatten Öffnungen, durch die der Rauch abziehen sollte, und die Reisenden husteten trotzdem.",
 "Die Einführung von Straßenlaternen wurde in mehreren europäischen Städten von Anwohnern bekämpft, teils aus Sorge, das Licht störe die göttliche Ordnung von Tag und Nacht, teils weil Nachtarbeit dadurch möglich wurde.",
 "Der Begriff Deadline stammt aus amerikanischen Gefangenenlagern des Bürgerkriegs: eine Linie, deren Überschreiten mit dem Erschießen beantwortet wurde.",
 "Die ersten Zeitungen erschienen wöchentlich, weil das Papier so teuer war — nicht, weil es zu wenig Nachrichten gab.",
 "Die Post der Republik Venedig verlangte für Briefe in den Orient eine Kaution, die zurückgezahlt wurde, wenn der Empfänger den Erhalt bestätigte — eine Versandverfolgung des 15. Jahrhunderts."
];
const QUOTES = [
